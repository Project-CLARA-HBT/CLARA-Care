...
- UX clarity note 2026-05-18: review thực tế từ end user cho thấy nhiều nhãn và flow còn khó hiểu với người ít tiếp xúc công nghệ.
  ...
  - `apps/web/components/research/lib/research-page-sections.tsx`: đồng bộ nhãn research, bỏ wording kỹ thuật như `research mode`, `retrieval`, `Fallback mode`, `RAG mode`, `Policy: Warn/Allow` khỏi UI chính.
