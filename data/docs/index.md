...
1. Proposal chính:
- `proposal/clara-full-proposal-2026-03-29.md`

2. Kiến trúc runtime:
- `architecture/clara-runtime-and-routing.md`
...
- `research/data/vn-medical-acquired-manifest-2026-03-29.jsonl`
- `research/data/vn-medical-acquired-report-2026-03-29.json`
- `research/data/vn-medical-pdf-sources-phase1-part1-2026-03-29.csv`
- `research/data/medical-safety-corpus-sources-2026-03-31.csv`
- `research/data/medical-safety-pubmed-queries-2026-03-31.csv`

6. DevOps vận hành:
- `devops/release-process.md`
- `devops/cd-pipeline.md`
- `devops/branch-protection.md`

## 2) Tài liệu cũ đã lưu trữ (archive)

- Toàn bộ tài liệu không thuộc bộ chính đã được chuyển vào:
- `archive/2026-03-30-cleanup/`
...
1. `proposal/clara-full-proposal-2026-03-29.md`
2. `architecture/clara-runtime-and-routing.md`
3. `implementation-plan/readme.md`
4. `implementation-plan/round2-14-day-execution-checklist-2026-03-30.md`
5. `research/market-need-and-regulatory-research.md`
6. `research/risk-deep-dive-and-mitigation.md`
...
- Tài liệu exploratory hoặc deep-dive mới phải để trong `archive/` trừ khi được promote lên bộ chính.
