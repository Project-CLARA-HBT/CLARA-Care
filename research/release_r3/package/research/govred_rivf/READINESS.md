...
Status: **FINAL FOUR-ARM EXECUTED AND ANALYZED — sealed claim-eligible executable primary schedules**. Final run `2026-08-17-rivf-final-003`, code revision `5b2c0dbf`, 450 logical cases per arm (180 NOT_RUN protocol exclusions, 270 EXECUTED per arm). Primary stale/unauthorized-commit acceptance: UNBOUND 0.571 (95% CI 0.504-0.636), STATE_VERSION_ONLY 0.429 (0.364-0.496), SNAPSHOT_BOUND_STATE_ONLY 0.429 (0.364-0.496), GLHS_STRICT 0.143 (0.102-0.197). Paired McNemar GLHS_STRICT vs UNBOUND p<0.0001 (b=90, c=0). Prohibited disclosure 0/270 all arms. Results in `artifacts/govred/2026-08-17-rivf-final-003/` (gitignored raw store) and `research/govred_rivf/results/analysis.json`. RIVF dual-model protocol QA remains `NOT_RUN_pending_router_key` and is recorded, not claimed.
...
3. The final locked manifest, independently reviewed frozen statistics plan, final test partition, classified raw observations, frozen analysis, and sealed `artifacts/govred/2026-08-17-rivf-final-003/` inventory are present and reconciled. The remaining primary-study gates are the 180 protocol-excluded cases, fresh holdout, repetition/auditability execution, and RIVF dual-model QA; none is silently counted as a zero or claimed as complete.
4. BigData Healthcare is held / extension-only, not an independent duplicate of final-003. Any second venue requires materially new frozen evidence and disclosure of shared parent-study evidence.
