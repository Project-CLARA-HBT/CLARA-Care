...
- Cache/index revocation failure observed by the service-owned observer: 0/270 in every arm; the adapter never directly invalidates cache and this is not a general cache-invalidation guarantee.
