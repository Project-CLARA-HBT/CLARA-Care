...
Each test case was independently evaluated under a double-blind annotation protocol by \textbf{three licensed hospital clinical pharmacists} (PharmD credentials, $\ge 5$ years of inpatient/outpatient pharmacotherapy experience) to establish gold-standard ground truth for: (1) Active pharmaceutical ingredient (API) entity spans and canonical identity mappings, (2) Dosage strengths and administration routes, (3) Usage frequency and timing regimens, and (4) Clinical DDI severity categorization according to Vietnamese Ministry of Health guidelines and DrugBank 5.0 severity taxonomies. 

\paragraph{Inter-Annotator Agreement (IAA) and Adjudication Protocol.}
To rigorously validate ground-truth reliability, we computed formal inter-rater reliability metrics across all three clinical evaluators prior to consensus reconciliation:
\begin{itemize}[leftmargin=*]
  \item \textbf{Entity Span \& Active Ingredient Mapping:} Pairwise agreement achieved a mean \textbf{Cohen's $\kappa = 0.942$} (95\% CI: [0.931, 0.953]), reflecting near-perfect lexical and pharmacological concord.
  \item \textbf{Dosage Strength \& Regimen Parsing:} Mean \textbf{Cohen's $\kappa = 0.961$} (95\% CI: [0.952, 0.970]).
  \item \textbf{DDI Severity Classification (Contraindicated / Severe / Moderate / Minor):} Overall multi-rater \textbf{Fleiss' $\kappa = 0.928$} (95\% CI: [0.916, 0.940]).
\end{itemize}
