...
\centering
\small
\caption{Architectural \& Semantic Simulation Comparison of Transactional \& Governance Paradigms ($N=500$ Workloads, $W=16$ Concurrent Simulated Workers). \textit{Note:} Throughput (TPS) and p95 latency reflect in-memory semantic simulation dispatch and conflict-evaluation times on identical hardware.}
