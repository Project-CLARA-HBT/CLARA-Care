...
\subsection{Bảng Tổng hợp Bằng chứng Kỹ thuật}
Bảng~\ref{tab:evidence_status_vi} tổng kết trạng thái bằng chứng hiện tại trong toàn bộ codebase.

\begin{table}[H]
\centering
\caption{Tổng hợp trạng thái bằng chứng kỹ thuật và đánh giá lâm sàng trong CareGuard-VN.}
\label{tab:evidence_status_vi}
\small
\begin{tabularx}{\textwidth}{p{4.2cm}p{3.2cm}X}
\toprule
\textbf{Hạng mục Bằng chứng} & \textbf{Trạng thái} & \textbf{Diễn giải Được phép} \\
\midrule
Kiểm tra Toàn vẹn Manifest/Index & Đã thẩm định đạt 100\% & Chứng thực kỹ thuật mã băm Merkle SQLite và chuyển trạng thái fail-closed. \\
Tuân thủ Runtime DrugBank Cùng Nguồn & 242/250 Dương; 250/250 Âm & Kiểm tra tuân thủ kỹ thuật của API triển khai trên gói dữ liệu DrugBank 5.0. \\
Đánh giá Đa phương thức Gemini 3.7 Flash & Hoàn tất ($N=150$) & F1 tên thuốc 98,1\%, Độ nhạy DDI 99,6\%, FNR 0,40\%, FIDES chặn 100,0\%. \\
Từ chối Lựa chọn Cũ / Mơ hồ & Đã kiểm thử & Thực thi hợp đồng trong các bộ kiểm thử tự động đơn vị và tích hợp. \\
Đánh giá Ngoài DAV / DDInter & Đang chờ chạy niêm phong & Giao thức đã khóa mã băm; đang chờ hoàn tất thu thập dữ liệu ngoài. \\
\bottomrule
\end{tabularx}
\end{table}
