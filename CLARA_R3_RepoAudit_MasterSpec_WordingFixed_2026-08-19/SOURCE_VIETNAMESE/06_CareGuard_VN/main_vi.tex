...
\toprule
\textbf{Kiến trúc / Mô hình} & \textbf{F1 Thực thể} & \textbf{Độ nhạy DDI} & \textbf{Tỷ lệ Báo An toàn Sai} & \textbf{Cổng Fail-Closed} & \textbf{Cơ chế An toàn} \\
\midrule
...
CrossDDI~\cite{crossddi2026} & Không áp dụng & 95,2\% & 2,90\% & Không & Xác minh DDI (giả định cặp thuốc chuẩn) \\
\textbf{CareGuard-VN (Công trình này)} & \textbf{98,1\%} & \textbf{99,6\%} & \textbf{0,40\%} & \textbf{100,0\% (FIDES)} & \textbf{Hợp đồng Định danh Gắn Nguồn (SBMI)} \\
\bottomrule
\end{tabularx}
\end{table*}
