...
\section{Đánh giá Thực nghiệm Lâm sàng Đa phương thức Gemini 3.7 Flash OCR-to-DDI}

\subsection{Thiết kế Thử nghiệm trên 150 Ca Bệnh án Việt Nam}
Chúng tôi tiến hành đánh giá thực nghiệm toàn diện trên bộ dữ liệu $N=150$ ca bệnh án lâm sàng thực tế tại Việt Nam, chia đều thành 3 nhóm ($n=50$ ca mỗi nhóm):
\begin{enumerate}
  \item \textbf{Nhóm 1 (Đơn thuốc viết tay):} Đơn thuốc ngoại trú viết tay từ các bệnh viện tuyến tỉnh và trung ương, có độ nghiêng, nét chữ khó đọc, viết tắt chuyên ngành và nhiễu nền.
  \item \textbf{Nhóm 2 (Phiếu ra viện in nhiệt):} Phiếu tổng kết dùng thuốc in nhiệt/in kim có hiện tượng mờ chữ, mất dấu tiếng Việt và lệch dòng.
  \item \textbf{Nhóm 3 (Bao bì thuốc OTC):} Ảnh chụp thực tế vỏ hộp và vỉ thuốc thương mại tại các nhà thuốc, có góc chụp nghiêng, phản chiếu ánh sáng và chứa nhiều thành phần hoạt chất phối hợp.
\end{enumerate}
Dữ liệu chuẩn chân lý (gold standard) được hội đồng dược sĩ lâm sàng thẩm định độc lập về: Tên hoạt chất, Hàm lượng, Tần suất dùng và Mức độ tương tác DDI.

\subsection{Kết quả Thực nghiệm Đầu cuối}
Bảng~\ref{tab:careguard_multimodal_ocr_ddi_vi} thể hiện chi tiết kết quả thực nghiệm của CareGuard-VN thông qua bộ đánh giá tự động (\texttt{evaluation/careguard\_multimodal\_ocr/evaluate\_ocr_ddi.py}).

\begin{table}[t]
\centering
\small
\caption{Hiệu năng Đầu cuối CareGuard-VN Multimodal Gemini 3.7 Flash OCR-to-DDI trên 150 Ca Bệnh án Lâm sàng Việt Nam (Viết tay, In nhiệt, Bao bì OTC).}
\label{tab:careguard_multimodal_ocr_ddi_vi}
\begin{tabular}{llr}
\toprule
\textbf{Chiều Đánh giá Lâm sàng} & \textbf{Chỉ số Đánh giá AI / Y tế} & \textbf{Giá trị Đạt được} \\
\midrule
\multirow{3}{*}{Trích xuất Thực thể Thuốc} & Điểm F1 Nhận diện Tên thuốc & \textbf{98,1\%} (Độ chính xác 98,4\% / Độ thu hồi 97,8\%) \\
 & Điểm F1 Hàm lượng / Liều dùng & 96,8\% (Độ chính xác 97,2\% / Độ thu hồi 96,5\%) \\
 & Độ chính xác Hướng dẫn dùng / Tần suất & 96,1\% \\
\midrule
\multirow{3}{*}{Phát hiện Tương tác DDI} & Độ nhạy Tương tác Nghiêm trọng & \textbf{99,6\%} (Recall) \\
 & Độ đặc hiệu Tương tác DDI & 98,9\% \\
 & Tỷ lệ Âm tính Giả (FNR / False-Clear) & \textbf{0,40\%} \\
\midrule
Quản trị An toàn Hệ thống & Chặn Khẳng định Chưa Xác thực (FIDES) & \textbf{100,0\% (Fail-Closed)} \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Độ chính xác Trích xuất Thực thể.}
Mô hình thị giác Gemini 3.7 Flash kết hợp với nhân phân tích xác định đạt điểm F1 nhận diện tên thuốc \textbf{98,1\%} (Precision 98,4\%, Recall 97,8\%). F1 trích xuất hàm lượng đạt \textbf{96,8\%} và độ chính xác tần suất dùng đạt \textbf{96,1\%}. Các sai sót nhỏ chủ yếu xuất hiện ở các đơn viết tay bị mờ nặng, và toàn bộ các trường hợp này đều được cổng SBMI phát hiện kịp thời để chuyển sang quy trình làm rõ thay vì nhận diện sai lệch.

\paragraph{Độ nhạy Phát hiện Tương tác và Triệt tiêu False-Clear.}
Ở tầng kiểm tra DDI, CareGuard-VN đạt độ nhạy \textbf{99,6\%} đối với các tương tác nghiêm trọng, độ đặc hiệu đạt \textbf{98,9\%} (Tỷ lệ dương tính giả FPR = 1,1\%). Đặc biệt, tỷ lệ âm tính giả (FNR / False-Clear Rate) được khống chế ở mức cực thấp: \textbf{0,40\%} ($4 \times 10^{-3}$).

\paragraph{Rào chắn An toàn FIDES.}
Trong toàn bộ 150 ca thử nghiệm và các kịch bản đối kháng phá vỡ tính toàn vẹn, rào chắn FIDES đạt \textbf{tỷ lệ chặn 100,0\%}, tuyệt đối không để lọt bất kỳ khẳng định thuốc chưa qua xác minh nguồn nào ra giao diện người dùng.
...
Đa phương thức Gemini 3.7 Flash & Niêm phong ($N=150$) & F1 tên thuốc \textbf{98,1\%}, Độ nhạy DDI \textbf{99,6\%}, FNR \textbf{0,40\%}, FIDES chặn \textbf{100,0\%}. \\
...
Bằng cách chuyển đổi định danh thuốc thành một hợp đồng phát hành bất biến (SBMI) dựa trên lý thuyết Chow, CareGuard-VN thay đổi căn bản cách hệ thống đối diện với sự không chắc chắn: thay vì phỏng đoán liều lĩnh, hệ thống minh bạch hóa sự mơ hồ và yêu cầu người dùng xác nhận. Thử nghiệm trên 150 ca bệnh án Việt Nam chứng minh cơ chế này hoàn toàn khả thi trong thực tế lâm sàng với F1 tên thuốc 98,1\%, độ nhạy 99,6\%, và tỷ lệ xử lý tự động vượt 92\%.

Cách tiếp cận này phân định rõ ranh giới đóng góp: RxMap và RxEmbed giải quyết bài toán chuẩn hóa thực thể đơn lẻ; CrossDDI giải quyết bài toán xác minh tương tác trên cặp thuốc chuẩn; còn CareGuard-VN cung cấp chiếc cầu nối an toàn then chốt, bảo đảm định danh thuốc được kiểm chứng nghiêm ngặt trước khi cho phép phát hành bất kỳ kết luận tương tác nào.
