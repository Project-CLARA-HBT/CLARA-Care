...
\paragraph{Hiệu quả giảm thiểu dữ liệu và tối ưu KV-cache.} Trên đoàn hệ 384 đối tượng, việc tinh gọn bối cảnh qua THSS giúp giảm $87{,}4\%$ prompt tokens (trung bình 412 so với 3.280 tokens, $p < 10^{-40}$) và giảm $68{,}2\%$ độ trễ suy luận, giảm dung lượng cấp phát bộ nhớ KV-cache từ 128,4 MB xuống 16,2 MB mỗi yêu cầu với độ lệch chẩn đoán null (70 thắng, 73 thua, 241 hòa, $\hat{\Delta} = -0{,}78\%$, $SE = 3{,}12\%$, $p_{\text{TOST}} = 0{,}348$, KTC 90\% $[-5{,}91\%, +4{,}35\%]$, kiểm định dấu $p=0{,}867$; cần $N \ge 7.500$ cho lực thống kê biên $\pm 2\%$).
