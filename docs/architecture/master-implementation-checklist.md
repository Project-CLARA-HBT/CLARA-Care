...
| 02 | i18n foundation | partial | typed vi/en catalog now covers the authenticated shell, auth/onboarding, Today, consumer chat, consent, LifeMap review, Medicines, Living Evidence, Research/source hub, Community, Scribe and administrative RAG web flows. Unified/Redesign mobile coverage now includes onboarding, chat, LifeMap, Medicines/cabinet, visits, family, profile/PHR, living evidence, connected health, community, Settings and More. Broader domain migration, scanner coverage and a shared generated catalog remain. |
...
| 15 | Mobile parity | partial | Unified mobile/locale/consent paths exist; catalog-backed onboarding, chat, LifeMap, Medicines/cabinet, visits, family/visit detail, profile/PHR, living evidence, connected health, community, Settings and More flows were added. Device E2E, generated shared terminology and broader parity remain. |
