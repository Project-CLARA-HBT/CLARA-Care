...
| Common longitudinal evidence interface | IN_PROGRESS | Noncanonical common record plus FHIR-NDJSON, Diabetes, eICU-offset, OMOP and nested-FHIR adapters | Provenance/time/missingness/minimization adapter tests | Local gitignored normalized outputs | Coherent and MEPS adapters pending; full SyntheticMass execution pending |
