...
| `/auth/callback` | public | — | Public auth callback | public E2E |
...
| `/lifemap/timeline` | authenticated owner/profile | personal | Context timeline | personal E2E |
...
| `/visits/[visitId]` | authenticated owner/profile | personal | Context visit detail reader | visit E2E |
| `/admin/users` | authenticated admin | admin | More Admin | admin E2E |
...
| `/medicines/[id]` | authenticated owner/profile + consent | personal | Context detail | medicines E2E |
| `/medicines/add` | authenticated owner/profile + consent | personal | Context guided add | medicines E2E |
| `/medicines/cabinet` | authenticated owner/profile + consent | personal | Context cabinet | medicines E2E |
...
| `/chat/[chatId]` | authenticated all roles | personal/research/clinical | Context direct chat session | Chat E2E |
...
| `/admin/system` | authenticated admin | admin | More Admin | admin E2E |
...
| `/admin/experiments` | authenticated admin | admin | More Admin | admin E2E |
| `/admin/feedback` | authenticated admin | admin | More Admin | admin E2E |
...
| `/admin/audit` | authenticated admin | admin | More Admin | admin E2E |
...
| `/you/settings` | authenticated owner/profile | personal | Rebuild consumer settings | settings E2E |
