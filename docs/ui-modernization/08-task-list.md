...
| UI-12 | FR-PHR-001/003 | PHR ProgressList/section UX and conflict-safe presentation. | Personal | UI-03/UI-04 | phr routes/components | form/provenance/a11y tests | done |
...
| FR-PHR | UI-03/UI-12 | icon, PHR routes/components | icon/form/provenance/E2E | done |
