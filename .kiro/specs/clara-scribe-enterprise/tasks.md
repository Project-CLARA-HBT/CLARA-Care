...
- [x] 4.9 **Property test P9** — structured-extraction provenance integrity + no-fabrication + RxCUI mapping. _Req 13.2, 13.3, 13.4, 13.6, 13.7_
...
- [x] 5.3 **Property test P10** — anti-upcoding (suggested E/M ≤ defensible level; every suggestion carries a span; none selected without confirmation). _Req 14.2, 14.3, 14.4, 14.5_
