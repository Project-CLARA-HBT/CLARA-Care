...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{gray}{GLHS: Disclosure-to-Commit Governance Protocol}}
...
\author{\textbf{Nguyen Ngoc Thien}\thanks{Primary contact: \texttt{kakangocthien109@gmail.com}} \quad\and\quad \textbf{Trinh Minh Quang}\\[0.35em]
...
\toprule
\textbf{Framework} & \textbf{Target Domain} & \textbf{Bitemporal} & \textbf{Binding} & \textbf{Lock Order} & \textbf{Deadlock} & \textbf{Epoch Gate} & \textbf{Formal Spec}\\
\midrule
