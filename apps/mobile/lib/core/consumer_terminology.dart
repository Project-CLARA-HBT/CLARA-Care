...
enum ConsumerTerm {
  ...
  socialDoctor,
  socialResearcher,
  socialReactionRelate,
  socialReactionThanks,
  socialFilterAll,
  socialFilterOfficial,
  socialFilterPeers,
  socialAllTopics,
  socialLeaveCommunity,
  socialLeaveConfirm,
  socialSearchPlaceholder,
  socialBookmarksTab,
  socialBookmarkAdded,
  socialBookmarkRemoved,
  socialReportReasonMisinformation,
  socialReportReasonPrescribing,
  socialReportReasonPii,
  socialReportReasonSpam,
  socialReportCommentTitle,
  socialReportCommentSent,
  socialOfficialBadge,
  socialPeerBadge,
  socialModeratedBadge,
  socialPostHidden,
  socialUnhidePosts,
  socialHideAction,
  socialSafetyGuidelinesTitle,
  socialSafetyGuidelinesText,
...
class ConsumerTerminology {
  ...
  static const Map<ConsumerTerm, String> _viMessages = {
    ...
    ConsumerTerm.socialReactionRelate: 'Đồng cảm',
    ConsumerTerm.socialReactionThanks: 'Cảm ơn',
    ConsumerTerm.socialFilterAll: 'Tất cả',
    ConsumerTerm.socialFilterOfficial: 'Chính thức',
    ConsumerTerm.socialFilterPeers: 'Thành viên',
    ConsumerTerm.socialAllTopics: 'Tất cả chủ đề',
    ConsumerTerm.socialLeaveCommunity: 'Rời cộng đồng',
    ConsumerTerm.socialLeaveConfirm:
        'Bạn có chắc muốn rời cộng đồng này? Bạn sẽ không còn nhận được cập nhật từ cộng đồng.',
    ConsumerTerm.socialSearchPlaceholder: 'Tìm kiếm bài viết, chủ đề…',
    ConsumerTerm.socialBookmarksTab: 'Đã lưu',
    ConsumerTerm.socialBookmarkAdded: 'Đã lưu bài viết.',
    ConsumerTerm.socialBookmarkRemoved: 'Đã bỏ lưu bài viết.',
    ConsumerTerm.socialReportReasonMisinformation:
        'Thông tin sai lệch hoặc gây hiểu lầm',
    ConsumerTerm.socialReportReasonPrescribing:
        'Kê đơn, chẩn đoán hoặc chỉ định liều dùng',
    ConsumerTerm.socialReportReasonPii:
        'Lộ thông tin cá nhân hoặc dữ liệu y tế nhạy cảm',
    ConsumerTerm.socialReportReasonSpam:
        'Spam, quảng cáo hoặc nội dung không phù hợp',
    ConsumerTerm.socialReportCommentTitle: 'Báo cáo bình luận',
    ConsumerTerm.socialReportCommentSent:
        'Đã gửi báo cáo bình luận. Cảm ơn bạn.',
    ConsumerTerm.socialOfficialBadge: 'Chính thức',
    ConsumerTerm.socialPeerBadge: 'Thành viên',
    ConsumerTerm.socialModeratedBadge: 'Đã kiểm duyệt',
    ConsumerTerm.socialPostHidden: 'Đã ẩn bài viết này.',
    ConsumerTerm.socialUnhidePosts: 'Bỏ ẩn tất cả bài viết',
    ConsumerTerm.socialHideAction: 'Ẩn bài viết',
    ConsumerTerm.socialSafetyGuidelinesTitle: 'Quy tắc an toàn cộng đồng',
    ConsumerTerm.socialSafetyGuidelinesText:
        'Cộng đồng CLARA là không gian hỗ trợ ngang hàng, không thay thế bác sĩ. Mọi nội dung kê đơn, chẩn đoán y tế, chỉ định liều dùng hoặc chứa thông tin cá nhân đều bị chặn tự động bởi hệ thống kiểm duyệt an toàn.',
  ...
  static const Map<ConsumerTerm, String> _enMessages = {
    ...
    ConsumerTerm.socialReactionRelate: 'Relate',
    ConsumerTerm.socialReactionThanks: 'Thanks',
    ConsumerTerm.socialFilterAll: 'All',
    ConsumerTerm.socialFilterOfficial: 'Official',
    ConsumerTerm.socialFilterPeers: 'Peers',
    ConsumerTerm.socialAllTopics: 'All topics',
    ConsumerTerm.socialLeaveCommunity: 'Leave community',
    ConsumerTerm.socialLeaveConfirm:
        'Are you sure you want to leave this community? You will no longer receive updates from it.',
    ConsumerTerm.socialSearchPlaceholder: 'Search posts, topics…',
    ConsumerTerm.socialBookmarksTab: 'Bookmarks',
    ConsumerTerm.socialBookmarkAdded: 'Post bookmarked.',
    ConsumerTerm.socialBookmarkRemoved: 'Post removed from bookmarks.',
    ConsumerTerm.socialReportReasonMisinformation:
        'Misinformation or misleading content',
    ConsumerTerm.socialReportReasonPrescribing:
        'Prescribing, diagnosis, or dosage advice',
    ConsumerTerm.socialReportReasonPii:
        'Personal identifying or private health data',
    ConsumerTerm.socialReportReasonSpam:
        'Spam, advertising, or inappropriate content',
    ConsumerTerm.socialReportCommentTitle: 'Report comment',
    ConsumerTerm.socialReportCommentSent:
        'Comment report sent. Thank you.',
    ConsumerTerm.socialOfficialBadge: 'Official',
    ConsumerTerm.socialPeerBadge: 'Peer',
    ConsumerTerm.socialModeratedBadge: 'Moderated',
    ConsumerTerm.socialPostHidden: 'Post hidden.',
    ConsumerTerm.socialUnhidePosts: 'Unhide all posts',
    ConsumerTerm.socialHideAction: 'Hide post',
    ConsumerTerm.socialSafetyGuidelinesTitle: 'Community Safety Guidelines',
    ConsumerTerm.socialSafetyGuidelinesText:
        'The CLARA community is a peer support space and does not replace medical advice. Prescribing, diagnosis, dosage instructions, or private health data are automatically blocked by the safety moderation system.',
