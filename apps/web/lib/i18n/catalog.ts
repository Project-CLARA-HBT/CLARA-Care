...
const VI_MESSAGES = {
  ...
  "workspace.shared.zeroCotBadge": "Bảo mật riêng tư Zero-CoT",
  ...
  "medicines.workspace.ddi.badge": "DrugBank v5.1 & Xác thực An toàn",
  "medicines.workspace.ddi.highlight1": "Quy tắc 2 thuốc: Tối thiểu 2 hoạt chất phân biệt",
  "medicines.workspace.ddi.highlight2": "Xác thực nguồn từ DrugBank v5.1 & đối soát đa tầng",
  ...
  "medicines.cabinet.verifiedDescription": "CLARA không tự phỏng đoán cảnh báo khi chưa kiểm tra. Hãy mở phần Kiểm tra tương tác thuốc để đối chiếu với nguồn dữ liệu dược thư chính thống; nếu chưa đủ cơ sở xác thực, hệ thống sẽ tạm dừng để đảm bảo an toàn cho bạn.",
