...
const VI_MESSAGES = {
  ...
  "council.result.hierarchy.evidence": "5. Bằng chứng & Trích dẫn",
  "council.result.hierarchy.clinicianAction": "6. Hành động của Bác sĩ",
...
const EN_MESSAGES: MessageCatalog = {
  ...
  "council.result.hierarchy.evidence": "5. Evidence & Citations",
  "council.result.hierarchy.clinicianAction": "6. Clinician Action",
