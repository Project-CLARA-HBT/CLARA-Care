...
const VI_MESSAGES = {
  ...
  "scribe.recordingData.description": "Chỉ dùng khi bạn muốn xóa phần dữ liệu được tạo từ lần ghi âm của phiên đang chọn.",
  "scribe.recordingData.deletes": "Xóa bản ghi chữ và thông tin đoạn phiên âm/nhận diện người nói đã lưu.",
  "scribe.recordingData.audioNotStored": "Tệp âm thanh gốc không được CLARA lưu trữ.",
  "scribe.recordingData.retained": "Ghi chú đã ký (nếu có) và nhật ký kiểm toán vẫn được giữ nguyên.",
  ...
  "scribe.recordingData.confirmDescription": "Thao tác này xóa bản ghi chữ và thông tin đoạn phiên âm của phiên đang chọn. Không thể hoàn tác.",
  "scribe.recordingData.confirmRetained": "CLARA không lưu tệp âm thanh gốc. Ghi chú đã ký và nhật ký kiểm toán không bị xóa.",
  "scribe.recordingData.confirmAction": "Xác nhận xóa dữ liệu phiên âm",
  "scribe.recordingData.cancel": "Hủy",
  "scribe.recordingData.notice.deleted": "Đã xóa dữ liệu phiên âm của phiên này.",
...
const EN_MESSAGES: MessageCatalog = {
  ...
  "scribe.recordingData.description": "Use this only when you want to delete data derived from recording the selected session.",
  "scribe.recordingData.deletes": "Deletes the stored transcript and ASR/diarization segment metadata.",
  "scribe.recordingData.audioNotStored": "CLARA does not store the original audio file.",
  "scribe.recordingData.retained": "Any signed clinical note and the audit trail remain intact.",
  ...
  "scribe.recordingData.confirmDescription": "This deletes the transcript and transcription-segment metadata for the selected session. It cannot be undone.",
  "scribe.recordingData.confirmRetained": "CLARA does not store the original audio file. Signed notes and the audit trail are not deleted.",
  "scribe.recordingData.confirmAction": "Confirm transcription-data deletion",
  "scribe.recordingData.cancel": "Cancel",
  "scribe.recordingData.notice.deleted": "The session's transcription data was deleted.",
