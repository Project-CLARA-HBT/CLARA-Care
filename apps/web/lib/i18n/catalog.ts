...
const VI_MESSAGES = {
  ...
  "navigation.item.ask.subtitle": "Hỏi điều bạn đang lo; CLARA sẽ hướng dẫn bước an toàn tiếp theo.",
  ...
  "navigation.item.health.subtitle": "Quản lý hồ sơ y tế, lịch sử và thuốc đã xác nhận.",
  ...
  "navigation.item.care.subtitle": "Chuẩn bị buổi khám và theo dõi lịch chăm sóc.",
  ...
  "navigation.item.you.subtitle": "Quản lý hồ sơ, chia sẻ người thân và quyền riêng tư.",
  ...
  "navigation.item.dashboard.subtitle": "Theo dõi nhanh các tác vụ chăm sóc và vận hành trong ngày.",
  ...
  "navigation.item.research.subtitle": "Phân tích chuyên sâu với nguồn, độ chắc chắn và dấu vết luận điểm.",
  ...
  "navigation.item.evidence.subtitle": "Gắn câu hỏi với hành trình, xem nguồn và phần chưa chắc chắn.",
  ...
  "navigation.item.selfmed.subtitle": "Quản lý thuốc đang dùng và quét toa thuốc từ ảnh.",
  ...
  "navigation.item.careguard.subtitle": "Đối chiếu thuốc, dị ứng và triệu chứng để phát hiện rủi ro sớm.",
  ...
  "navigation.item.sourceHub.subtitle": "Đồng bộ và tra cứu các nguồn y khoa phục vụ phân tích bằng chứng.",
  ...
  "navigation.item.council.subtitle": "Tập hợp ý kiến đa chuyên khoa để xử lý ca khó.",
  ...
  "navigation.item.scribe.subtitle": "Soạn ghi chú khám nhanh theo định dạng rõ ràng, nhất quán.",
  ...
  "navigation.item.adminOverview.subtitle": "Bảng điều phối trung tâm cho cấu hình, chất lượng phản hồi và vận hành.",
  ...
  "navigation.item.adminKnowledgeSources.subtitle": "Trung tâm hợp nhất connector truy xuất, tài liệu và đồng bộ nguồn y khoa.",
  ...
  "navigation.item.adminAnswerFlow.subtitle": "Điều phối các bước phân tích, xác minh và phản hồi cuối.",
  ...
  "navigation.item.adminObservability.subtitle": "Theo dõi tình trạng hệ thống, cảnh báo và tín hiệu runtime.",
  ...
  "navigation.item.adminModeration.subtitle": "Xem xét và xử lý các báo cáo nội dung từ cộng đồng.",
  ...
  "navigation.item.adminAnalytics.subtitle": "Xu hướng người dùng, mức độ sử dụng theo khu vực, phễu chuyển đổi và giữ chân.",
  ...
  "navigation.item.adminClinicalAnalytics.subtitle": "Phán quyết kiểm chứng FIDES, phân bố tương tác thuốc và độ trễ theo tầng.",
  ...
  "guide.tasks.chat.detail": "Dùng khi bạn cần câu trả lời nhanh, dễ đọc, có nhắc an toàn.",
  ...
  "guide.tasks.thinking.detail": "Dùng Tư duy hoặc Pro khi cần phân tích dài, nhiều nguồn hơn.",
  "guide.tasks.thinking.step1": "Bấm nút chỉnh chế độ cạnh ô nhập.",
  "guide.tasks.thinking.step2": "Chọn Tư duy cho phân tích kỹ hơn, Pro cho báo cáo dài.",
  "guide.tasks.thinking.step3": "Chọn Đầy đủ nguồn nếu muốn CLARA kiểm tra nhiều nguồn hơn.",
  "guide.tasks.thinking.action": "Mở chế độ Tư duy",
  "guide.tasks.cabinet.title": "Tôi muốn lưu thuốc đang dùng",
  "guide.tasks.cabinet.detail": "Tủ thuốc giúp CLARA nhớ danh sách thuốc để kiểm tra tương tác.",
  "guide.tasks.cabinet.step1": "Thêm từng thuốc hoặc quét ảnh đơn thuốc.",
  "guide.tasks.cabinet.step2": "Bổ sung liều dùng nếu biết.",
  "guide.tasks.cabinet.step3": "Khi có ít nhất 2 thuốc, chạy kiểm tra tương tác.",
  "guide.tasks.cabinet.action": "Mở tủ thuốc",
  "guide.tasks.interactions.title": "Tôi muốn kiểm tra hai thuốc có kỵ nhau không",
  "guide.tasks.interactions.detail": "Dùng mục kiểm tra tương tác thuốc trước khi phối hợp nhiều thuốc.",
  ...
  "guide.tasks.interactions.step3": "Đọc cặp thuốc bị cảnh báo và phần Bạn nên làm gì.",
  "guide.tasks.interactions.action": "Kiểm tra tương tác",
  "guide.tasks.council.title": "Tôi là bác sĩ và cần hội chẩn ca khó",
  "guide.tasks.council.detail": "Tham khảo nhiều chuyên khoa phù hợp khi ca có nhiều hướng xử trí hoặc nhiều chuyên khoa.",
  ...
  "guide.tasks.council.step3": "Dùng kết quả như tài liệu tham khảo, không thay thế quyết định lâm sàng.",
  "guide.tasks.council.action": "Mở tham khảo nhiều chuyên khoa",
  "guide.tasks.scribe.title": "Tôi muốn ghi lại buổi khám",
  "guide.tasks.scribe.detail": "Ghi chép buổi khám giúp chuyển ghi chú thành bản tóm tắt có cấu trúc.",
  "guide.tasks.scribe.step1": "Nhập hoặc dán nội dung buổi khám.",
  "guide.tasks.scribe.step2": "Kiểm tra lại bản ghi có cấu trúc trước khi dùng.",
  "guide.tasks.scribe.step3": "Không đưa thông tin nhạy cảm nếu chưa có đồng ý phù hợp.",
  ...
  "guide.labels.quick.meaning": "Trả lời ngắn, ít chờ, hợp với câu hỏi đơn giản.",
  "guide.labels.thinking.term": "Tư duy",
  "guide.labels.thinking.meaning": "Phân tích kỹ hơn, hợp với câu hỏi cần lý giải.",
  "guide.labels.pro.term": "Pro",
  "guide.labels.pro.meaning": "Báo cáo dài và đầy đủ hơn, dùng khi cần nghiên cứu sâu.",
  "guide.labels.autoSources.term": "Tự chọn nguồn",
  "guide.labels.autoSources.meaning": "CLARA tự chọn phạm vi nguồn phù hợp để tiết kiệm thời gian.",
  "guide.labels.fullSources.term": "Đầy đủ nguồn",
  "guide.labels.fullSources.meaning": "CLARA kiểm tra nhiều nguồn hơn, có thể chờ lâu hơn.",
  "phr.ocr.open": "Quét đơn thuốc (OCR)",
  "phr.ocr.title": "Xem lại kết quả OCR",
  "phr.ocr.intro": "Tải lên ảnh hoặc tệp đơn thuốc. Không có mục nào được lưu cho đến khi bạn xác nhận.",
  "phr.ocr.disclosure": "Tôi đồng ý gửi tệp này để trích xuất các thuốc cần xem lại. CLARA không tự lưu thuốc từ kết quả OCR.",
  "phr.ocr.consentNotice": "Bạn cần có đồng ý y tế phù hợp trước khi CLARA gửi tệp đến dịch vụ OCR đã cấu hình.",
  "phr.ocr.processingNotice": "CLARA không lưu tệp tải lên; hãy kiểm tra từng mục trước khi lưu vào hồ sơ.",
  ...
  "phr.share.description": "Tạo liên kết chỉ đọc để chia sẻ hồ sơ. Bạn có thể thu hồi bất cứ lúc nào.",
  ...
  "phr.shared.unavailable": "Liên kết chia sẻ không hợp lệ, đã hết hạn hoặc đã bị thu hồi.",
  ...
  "phr.shared.observations": "Chỉ số sinh hiệu & Đo lường",
  "phr.shared.results": "Kết quả xét nghiệm",
  "phr.shared.emergencyContact": "Liên hệ khẩn cấp",
  "phr.shared.safety": "Nếu có dấu hiệu nguy hiểm hoặc cần trợ giúp khẩn cấp, hãy liên hệ cơ sở y tế gần nhất.",
  ...
  "workspace.shared.unavailable": "Liên kết chia sẻ không hợp lệ, đã hết hạn hoặc đã bị thu hồi.",
  ...
  "phr.export.description": "Tải hồ sơ dưới định dạng FHIR R4 (application/fhir+json) để chia sẻ với cơ sở y tế.",
  ...
  "phr.emergencyCard.description": "Chọn các mục hiển thị trên thẻ khẩn cấp. Bản xem trước cập nhật ngay bên dưới.",
  ...
  "phr.reminders.description": "Đặt nhắc cho thuốc đang dùng có tần suất, theo dõi lượng còn lại và nhắc người chăm sóc.",
  "phr.reminders.medication": "Thuốc",
  "phr.reminders.chooseMed": "Chọn thuốc",
  "phr.reminders.noEligible": "Chưa có thuốc đang dùng kèm tần suất. Hãy thêm tần suất cho thuốc trước.",
  ...
  "account.dataDelete.reviewDescription": "Hãy đọc hệ quả trước. Bạn vẫn có thể quay lại Dữ liệu của tôi mà chưa gửi yêu cầu.",
  "account.dataDelete.confirmTitle": "Xác nhận yêu cầu xóa",
  "account.dataDelete.confirmDescription": "Chỉ gửi khi bạn hiểu đây là yêu cầu không thể hoàn tác.",
  ...
  "account.dataDelete.consequence": "CLARA sẽ xử lý yêu cầu xóa hoặc ẩn danh hóa dữ liệu cá nhân của bạn theo thời hạn luật định.",
  "account.dataDelete.retentionTitle": "Dữ liệu được giữ lại",
  "account.dataDelete.retention": "Một số bản ghi audit/tuân thủ không chứa dữ liệu định danh vẫn có thể được giữ theo nghĩa vụ pháp lý.",
  "account.dataDelete.confirmation": "Tôi hiểu yêu cầu này có thể xóa hoặc ẩn danh hóa dữ liệu cá nhân và không thể hoàn tác.",
  ...
  "account.dataDelete.unknownReceipt": "Không tìm thấy biên nhận này. Bạn có thể xem lịch sử yêu cầu của mình.",
  "account.dataDelete.unavailable": "Yêu cầu quyền dữ liệu hiện chưa được bật cho môi trường này.",
  ...
  "admin.dsar.description": "Theo dõi và xử lý các yêu cầu của chủ thể dữ liệu theo Nghị định 13/2023/NĐ-CP, đối chiếu với thời hạn luật định.",
  "admin.dsar.disabled": "Tính năng yêu cầu quyền dữ liệu (DSAR) hiện chưa được bật cho môi trường này.",
  ...
  "navigation.item.consent.subtitle": "Cấp hoặc rút đồng thuận cho từng mục đích xử lý dữ liệu cá nhân.",
  ...
  "navigation.item.dataRights.subtitle": "Thực hiện quyền của chủ thể dữ liệu: xuất, chỉnh sửa, xóa, hạn chế và rút đồng thuận.",
  ...
  "navigation.item.dsar.subtitle": "Theo dõi và xử lý các yêu cầu của chủ thể dữ liệu theo thời hạn luật định.",
  ...
  "navigation.item.community.subtitle": "Chia sẻ kinh nghiệm và hỗ trợ nhau. Không phải tư vấn y tế — nội dung được kiểm duyệt.",
  "navigation.page.researchRedirect.title": "Hỏi đáp y tế",
  "navigation.page.researchRedirect.subtitle": "Luồng hỏi đáp đã hợp nhất về CLARA Chat.",
  "navigation.page.controlTower.title": "Điều phối tri thức",
  "navigation.page.controlTower.subtitle": "Thiết lập nguồn dữ liệu và luồng phản hồi cho hệ thống hỏi đáp.",
  "navigation.page.ecosystem.title": "Hệ sinh thái đối tác",
  "navigation.page.ecosystem.subtitle": "Theo dõi trạng thái kết nối và độ tin cậy dữ liệu liên thông.",
  "navigation.page.default.title": "Không gian làm việc",
  "navigation.page.default.subtitle": "Nền tảng trợ lý y tế giúp bạn xử lý công việc nhanh và rõ ràng hơn.",
  ...
  "familyCircle.relationships.description": "Chỉ những nội dung bạn đã chấp nhận hỗ trợ mới xuất hiện ở đây.",
  ...
  "today.completedDescription": "Các việc hoàn tất đã được ghi nhận. Bạn có thể nghỉ ngơi hoặc cập nhật nếu có thay đổi.",
  ...
  "today.caughtUpDescription": "Hành trình của bạn vẫn đang được theo dõi. Mở LifeMap để xem hoặc điều chỉnh bước tiếp theo.",
  ...
  "today.emergencyCardDesc": "Thông tin nhóm máu, dị ứng & liên hệ sống còn khi cần hỗ trợ tức thì.",
  "today.emergencyCardAction": "Xem thẻ cấp cứu",
  "today.whatsNew": "Có gì thay đổi?",
  "today.whatsNewDesc": "Kết quả xét nghiệm và đơn thuốc được cập nhật an toàn từ hồ sơ của bạn.",
  ...
  "today.askPlaceholder": "Hỏi về thuốc, triệu chứng hoặc kế hoạch chăm sóc…",
  ...
  "today.taskDetail.pageDescription": "Xem một việc, hiểu thời điểm cần làm, rồi mới xác nhận hoàn tất.",
  "today.taskDetail.completedPageTitle": "Đã hoàn tất",
  "today.taskDetail.completedPageDescription": "Việc này đã được ghi nhận. Bạn có thể quay lại xem ưu tiên tiếp theo.",
  "today.taskDetail.completedTitle": "Đã ghi nhận hoàn tất",
  "today.taskDetail.completedDescription": "CLARA không tự suy diễn thêm hành động chăm sóc từ việc này.",
  ...
  "today.taskDetail.completeGuidance": "Chỉ xác nhận khi bạn đã thực hiện việc này. Nếu kế hoạch không còn phù hợp, hãy quay lại LifeMap để xem và điều chỉnh bối cảnh.",
  ...
  "today.taskDetail.notFoundDescription": "Có thể việc đã hoàn tất, được điều chỉnh, hoặc bạn đang mở một liên kết cũ.",
  "today.taskDetail.activityTitle": "Lịch sử hoạt động & Ghi nhận",
  "chatShares.title": "Quản lý liên kết chia sẻ",
  "chatShares.description": "Quản lý các liên kết công khai của cuộc trò chuyện. Bạn có thể thu hồi quyền truy cập bất cứ lúc nào.",
  ...
  "lifemap.wizard.step.condition": "2. Bệnh nền & Thuốc",
  "lifemap.wizard.step.milestones": "3. Kế hoạch & Chỉ số",
  "lifemap.wizard.step.companions": "4. Người đồng hành & Nhắc nhở",
  "lifemap.wizard.step.commitment": "5. Xem trước & Cam kết",
  "lifemap.wizard.goal.title": "Mục tiêu sức khỏe của bạn là gì?",
  "lifemap.wizard.goal.description": "Chọn gợi ý mục tiêu phổ biến bên dưới hoặc tự nhập tên cho hành trình bạn muốn theo dõi.",
  "lifemap.wizard.goal.templateLabel": "Gợi ý mục tiêu nhanh:",
  "lifemap.wizard.goal.template1": "Kiểm soát huyết áp & tim mạch",
  "lifemap.wizard.goal.template1Desc": "Theo dõi chỉ số huyết áp hàng ngày và duy trì chế độ ít muối.",
  "lifemap.wizard.goal.template2": "Ổn định đường huyết & dinh dưỡng",
  "lifemap.wizard.goal.template2Desc": "Kiểm soát đường huyết đói và sau ăn, ghi nhật ký bữa ăn.",
  "lifemap.wizard.goal.template3": "Cải thiện giấc ngủ & giảm căng thẳng",
  "lifemap.wizard.goal.template3Desc": "Ghi nhận số giờ ngủ, chất lượng giấc ngủ và thời gian thức dậy.",
  "lifemap.wizard.goal.template4": "Phục hồi vận động khớp gối",
  "lifemap.wizard.goal.template4Desc": "Tập vật lý trị liệu hàng ngày và theo dõi mức độ đau khi đi lại.",
  "lifemap.wizard.goal.template5": "Theo dõi rối loạn mỡ máu",
  "lifemap.wizard.goal.template5Desc": "Kiểm soát LDL-C, duy trì chế độ ăn lành mạnh và lịch xét nghiệm lipid máu.",
  "lifemap.wizard.goal.template6": "Tùy chỉnh cá nhân",
  "lifemap.wizard.goal.template6Desc": "Tự thiết lập hành trình theo dõi sức khỏe và mục tiêu riêng biệt.",
  ...
  "lifemap.wizard.goal.customGoalPlaceholder": "Ví dụ: Duy trì huyết áp dưới 130/80 mmHg và uống thuốc đều đặn mỗi sáng.",
  "lifemap.wizard.condition.title": "Thông tin bệnh lý & Triệu chứng ban đầu",
  "lifemap.wizard.condition.description": "Ghi nhận chẩn đoán liên quan và triệu chứng hiện tại để kế hoạch theo dõi được sát với thực tế.",
  "lifemap.wizard.condition.cabinetTitle": "Tủ thuốc cá nhân (Tự động nhận diện)",
  "lifemap.wizard.condition.cabinetEmpty": "Chưa có thuốc trong tủ thuốc cá nhân.",
  "lifemap.wizard.condition.addMedication": "Thêm thuốc",
  "lifemap.wizard.condition.addMedicationPlaceholder": "Nhập tên thuốc và hàm lượng (ví dụ: Amlodipine 5mg)...",
  "lifemap.wizard.condition.trackedMedsLabel": "Đơn thuốc theo dõi trong hành trình:",
  "lifemap.wizard.condition.optDyslipidemia": "Rối loạn mỡ máu (Lipid máu)",
  "lifemap.wizard.condition.optPregnancy": "Chăm sóc thai kỳ / Sản khoa",
  "lifemap.wizard.condition.optPostop": "Hậu phẫu / Phục hồi chức năng",
  ...
  "lifemap.wizard.condition.symptomsPlaceholder": "Ví dụ: Hay đau nhức gáy vào sáng sớm, chóng mặt khi đổi tư thế đột ngột...",
  ...
  "lifemap.wizard.condition.priorityHint": "Mức ưu tiên giúp sắp xếp thứ tự hiển thị nhiệm vụ trên bảng điều khiển.",
  "lifemap.wizard.milestones.title": "Lập kế hoạch mốc mục tiêu",
  "lifemap.wizard.milestones.description": "Xác định các mốc kiểm tra và lịch tái khám định kỳ để đo lường tiến độ sức khỏe.",
  "lifemap.wizard.milestones.targetBpLabel": "Huyết áp mục tiêu (mmHg)",
  "lifemap.wizard.milestones.targetBpPlaceholder": "< 130/80 mmHg",
  "lifemap.wizard.milestones.targetGlucoseLabel": "Đường huyết đói mục tiêu (mmol/L)",
  "lifemap.wizard.milestones.targetGlucosePlaceholder": "< 7.0 mmol/L",
  ...
  "lifemap.wizard.milestones.cadenceTwiceWeekly": "2 lần/tuần (Twice weekly)",
  ...
  "lifemap.wizard.companions.title": "Người đồng hành & Nhắc nhở thông minh",
  "lifemap.wizard.companions.description": "Cài đặt giờ nhắc uống thuốc và chia sẻ thông tin theo dõi cho người thân hoặc bác sĩ phụ trách.",
  "lifemap.wizard.companions.reminderTitle": "Giờ nhắc uống thuốc thông minh",
  "lifemap.wizard.companions.slotMorning": "Sáng (08:00)",
  "lifemap.wizard.companions.slotNoon": "Trưa (12:00)",
  "lifemap.wizard.companions.slotEvening": "Chiều (18:00)",
  "lifemap.wizard.companions.slotNight": "Tối (20:00)",
  "lifemap.wizard.companions.addReminder": "Thêm giờ nhắc",
  "lifemap.wizard.companions.shareTitle": "Người đồng hành & Bác sĩ phụ trách",
  "lifemap.wizard.companions.nameLabel": "Tên người thân / Bác sĩ phụ trách",
  "lifemap.wizard.companions.namePlaceholder": "Ví dụ: BS. Nguyễn Văn A hoặc Con gái (Lan)",
  "lifemap.wizard.companions.roleLabel": "Vai trò người đồng hành",
  "lifemap.wizard.companions.roleFamily": "Người thân trong gia đình",
  "lifemap.wizard.companions.roleDoctor": "Bác sĩ điều trị / Bác sĩ phụ trách",
  "lifemap.wizard.companions.roleCaregiver": "Người chăm sóc y tế",
  "lifemap.wizard.companions.contactLabel": "Số điện thoại hoặc Email",
  "lifemap.wizard.companions.contactPlaceholder": "Ví dụ: 0912345678 hoặc doctor@clara.care",
  "lifemap.wizard.companions.notifyAlerts": "Nhận thông báo khi chỉ số vượt ngưỡng an toàn",
  "lifemap.wizard.companions.notifySummary": "Gửi báo cáo tóm tắt tiến độ hàng tuần",
  "lifemap.wizard.preview.title": "Xem trước hành trình & Cam kết GLHS",
  "lifemap.wizard.preview.description": "Bản tóm tắt trực quan hành trình trước khi chính thức kích hoạt vào sổ cái y tế GLHS.",
  "lifemap.wizard.preview.cardTitle": "Thẻ tóm tắt hành trình LifeMap",
  "lifemap.wizard.preview.glhsBadge": "Sổ cái GLHS v2 • 6-Phase OCC Kernel",
  "lifemap.wizard.preview.glhsSecurityNote": "Hành trình này được mã hóa và bảo vệ tính bất biến theo chuẩn Governed Longitudinal Health State.",
  "lifemap.wizard.commitment.title": "Cam kết & Khởi động hành trình",
  "lifemap.wizard.commitment.description": "Kiểm tra lại toàn bộ kế hoạch và xác nhận cam kết tự chăm sóc sức khỏe.",
  ...
  "lifemap.wizard.commitment.statement": "Tôi cam kết thực hiện kế hoạch theo dõi sức khỏe này và chủ động trao đổi với bác sĩ khi có bất thường.",
  "lifemap.wizard.commitment.disclaimer": "Lưu ý an toàn: LifeMap là công cụ hỗ trợ người bệnh tự theo dõi, không thay thế chẩn đoán hay điều trị y tế chính thức.",
  "lifemap.wizard.commitment.submit": "Cam kết & Bắt đầu hành trình",
  "lifemap.wizard.commitment.activateAction": "Kích hoạt hành trình & Cam kết GLHS",
  ...
  "lifemap.wizard.error.commitmentRequired": "Vui lòng đánh dấu xác nhận cam kết trước khi bắt đầu hành trình.",
  "lifemap.wizard.error.saveFailed": "Chưa thể khởi tạo hành trình do lỗi kết nối. Bản nháp đã được lưu an toàn.",
  "lifemap.timeline.eyebrow": "LifeMap",
  "lifemap.timeline.title": "Dòng thời gian sức khỏe mở rộng",
  "lifemap.timeline.description": "Dòng thời gian song trục (bitemporal) kết hợp mốc hành trình, nhật ký cá nhân và các lần thăm khám lâm sàng.",
  ...
  "lifemap.timeline.actions.viewTimeline": "Xem dòng thời gian",
  "lifemap.timeline.actions.exportHistory": "Xuất dữ liệu",
  "lifemap.timeline.actions.addNote": "Thêm ghi chú đính chính",
  ...
  "lifemap.timeline.perspective.validDesc": "Trật tự theo thời điểm bệnh nhân xuất hiện triệu chứng hoặc uống thuốc thực tế.",
  "lifemap.timeline.perspective.transactionDesc": "Trật tự theo thời điểm bác sĩ nhập liệu hoặc dữ liệu đồng bộ vào hệ thống.",
  ...
  "lifemap.timeline.filter.type.medications": "Thuốc & Dược phẩm",
  "lifemap.timeline.filter.type.labs": "Xét nghiệm & Cận lâm sàng",
  "lifemap.timeline.filter.type.symptoms": "Triệu chứng",
  "lifemap.timeline.filter.type.reports": "Báo cáo & Giấy tờ",
  ...
  "lifemap.timeline.empty.description": "Không có sự kiện nào khớp với bộ lọc hiện tại. Thử chọn lại trục thời gian hoặc tìm kiếm khác.",
  ...
  "lifemap.timeline.item.medication": "Đơn thuốc / Dược phẩm",
  "lifemap.timeline.item.lab": "Kết quả xét nghiệm",
  "lifemap.timeline.item.symptom": "Triệu chứng lâm sàng",
  "lifemap.timeline.item.report": "Báo cáo / Tài liệu y tế",
  ...
  "lifemap.timeline.item.disputedNotice": "Sự kiện này đang trong quá trình khiếu nại và chờ chuyên gia lâm sàng xác minh.",
  "lifemap.timeline.inspector.validTime": "Thời điểm diễn ra (Valid Time)",
  "lifemap.timeline.inspector.transactionTime": "Thời điểm ghi nhận vào hệ thống (System Time)",
  "lifemap.timeline.inspector.revision": "Phiên bản sự kiện",
  "lifemap.timeline.inspector.truthState": "Trạng thái chân thực",
  "lifemap.timeline.inspector.attribution": "Nguồn gốc ghi nhận",
  "lifemap.timeline.inspector.sourceKind": "Loại nguồn dữ liệu",
  "lifemap.timeline.inspector.policyVersion": "Phiên bản chính sách bảo mật",
  "lifemap.timeline.inspector.integrity": "Tính toàn vẹn & Kiểm toán",
  "lifemap.timeline.inspector.revisionsTitle": "Lịch sử phiên bản",
  "lifemap.timeline.inspector.provenanceTitle": "Nguồn gốc & Tính toàn vẹn",
  "lifemap.timeline.inspector.truthStateDesc": "Trạng thái phản ánh mức độ thẩm định lâm sàng và quyền tài phán của dữ liệu.",
  "lifemap.timeline.dispute.placeholder": "Nhập lý do khiếu nại hoặc thông tin cần đính chính...",
  "lifemap.timeline.dispute.submitting": "Đang gửi khiếu nại...",
  "lifemap.timeline.correctiveModal.title": "Thêm ghi chú đính chính / bổ sung",
  "lifemap.timeline.correctiveModal.desc": "Ghi chú này sẽ được lưu bất biến vào lịch sử kiểm toán của sự kiện và tạo phiên bản mới.",
  "lifemap.timeline.correctiveModal.noteLabel": "Nội dung đính chính",
  "lifemap.timeline.correctiveModal.placeholder": "Ví dụ: Đính chính thời điểm uống thuốc sau ăn no, hoặc bổ sung phản ứng phụ nhẹ...",
  "lifemap.timeline.correctiveModal.authorLabel": "Người thực hiện đính chính",
  "lifemap.timeline.correctiveModal.save": "Lưu bản đính chính",
  "lifemap.timeline.export.success": "Đã xuất dòng thời gian thành công ({count} sự kiện)",
  "lifemap.timeline.journalModal.title": "Ghi nhật ký sức khỏe mới",
  "lifemap.timeline.journalModal.desc": "Ghi lại triệu chứng, chỉ số đo lường hoặc cảm nhận sức khỏe hôm nay.",
  ...
  "lifemap.timeline.journalModal.contentPlaceholder": "Ghi chú thêm về huyết áp đo được, thức ăn, thuốc đã uống...",
  ...
  "lifemap.timeline.journalModal.typeMedication": "Uống thuốc / Đổi liều",
  "lifemap.timeline.journalModal.typeReport": "Kết quả khám / Tài liệu",
  ...
  "chat.welcome.promise": "Nguồn khi có · Giới hạn được nói rõ · Tín hiệu an toàn theo ngữ cảnh",
  ...
  "chat.answerRenderer.releaseBoundary.description": "CLARA đã giữ lại phần kết luận vì bằng chứng chưa đáp ứng điều kiện kiểm tra. Bạn có thể thu hẹp câu hỏi, xem nguồn hoặc chuẩn bị thông tin để trao đổi với bác sĩ.",
  ...
  "medicines.description": "Quản lý thuốc đã xác nhận, tủ thuốc cá nhân và kiểm tra tương tác an toàn trong một nơi.",
  ...
  "medicines.workspace.activeTaking.desc": "Các loại thuốc trong phác đồ điều trị đang uống, đã được đối chiếu chuẩn danh mục.",
  "medicines.workspace.activeTaking.empty": "Chưa có thuốc nào trong phác đồ đang dùng.",
  "medicines.workspace.unresolved.title": "Cần xác nhận / Đề xuất chưa đối chiếu",
  "medicines.workspace.unresolved.desc": "Các thuốc chưa khớp danh mục chuẩn hoặc cần bổ sung thông tin liều trước khi xem là an toàn.",
  "medicines.workspace.unresolved.allReconciled": "Tất cả thuốc đang dùng đã được đối chiếu chuẩn danh mục.",
  "medicines.workspace.unresolved.pendingCount": "Có {count} thuốc cần rà soát lại thông tin đối chiếu",
  "medicines.workspace.ddi.title": "Kiểm tra tương tác thuốc (Drug Interaction Guard)",
  "medicines.workspace.ddi.desc": "Đối chiếu tự động giữa các loại thuốc đang dùng và tủ thuốc để phát hiện xung đột dược lý, chống chỉ định và tương tác bất lợi.",
  "medicines.workspace.ddi.badge": "DrugBank v5.1 & FIDES",
  "medicines.workspace.ddi.highlight1": "Quy tắc 2 thuốc: Tối thiểu 2 hoạt chất phân biệt",
  "medicines.workspace.ddi.highlight2": "Xác thực nguồn DrugBank v5.1 & FIDES verification",
  "medicines.workspace.ddi.highlight3": "Cơ chế Fail-closed: Không báo an toàn giả khi thiếu dữ liệu",
  "medicines.workspace.ddi.action": "Mở công cụ kiểm tra tương tác",
  "medicines.workspace.ddi.ready": "Đủ dữ liệu ({count} hoạt chất) để kiểm tra tương tác.",
  "medicines.workspace.ddi.needsTwo": "Cần ít nhất 2 hoạt chất phân biệt để đối chiếu tương tác.",
  "medicines.workspace.cabinet.title": "Tủ thuốc gia đình (Tồn kho dự phòng)",
  "medicines.workspace.cabinet.desc": "Danh mục thuốc lưu trữ và sở hữu tại nhà. Đây là kho thuốc dự phòng, KHÔNG tự động tính vào phác đồ đang uống.",
  "medicines.workspace.cabinet.disclaimer": "Thuốc trong tủ là tồn kho dự trữ gia đình. Chưa được đưa vào đơn thuốc đang dùng thực tế.",
  ...
  "medicines.cabinet.wizard.safetyNote": "Lưu ý an toàn: Thuốc thêm vào tủ thuốc gia đình chỉ là danh mục sở hữu/tồn kho dự phòng tại nhà, KHÔNG tự động kích hoạt thành đơn thuốc đang dùng. Cần kiểm tra tương tác trước khi phối hợp sử dụng.",
  "medicines.cabinet.wizard.aside": "Tủ thuốc gia đình là nơi lưu trữ tồn kho dự phòng. Dữ liệu này độc lập với phác đồ điều trị đang uống.",
  ...
  "flow.fixBeforeContinue": "Có một vài mục cần được sửa trước khi bạn tiếp tục.",
  ...
  "visits.howPrepWorksDesc": "CLARA giúp bạn tổng hợp triệu chứng, thuốc đang dùng, câu hỏi cần trao đổi với bác sĩ và lưu trữ an toàn hồ sơ sau khám.",
  ...
  "visitWizard.desc.reason": "Xác định mục tiêu chính, chuyên khoa và bác sĩ bạn dự kiến thăm khám.",
  ...
  "visitWizard.desc.symptoms": "Ghi nhận các dấu hiệu bất thường, thời điểm xuất hiện và mức độ ảnh hưởng đến sinh hoạt.",
  ...
  "visitWizard.desc.medications": "Tổng hợp đơn thuốc đang dùng, mức độ tuân thủ liều và các phản ứng dị ứng đã từng gặp.",
  ...
  "visitWizard.desc.summary": "CLARA đã tổng hợp thông tin thành bản Handoff Pack tiêu chuẩn lâm sàng và gợi ý các câu hỏi trọng tâm.",
  ...
  "visitDetail.rx.safetyCheck": "Đối soát an toàn thuốc DrugBank: Không phát hiện tương tác nguy cơ cao.",
  ...
  "consent.ledgerSubtitle": "Quản lý cấp và rút quyền theo từng mục đích lâm sàng và kỹ thuật chuyên biệt",
  "consent.overview.title": "Tổng quan Đồng thuận theo Luật Khám bệnh 2023 & Nghị định 13",
  "consent.overview.subtitle": "Ranh giới lâm sàng & Bảo vệ dữ liệu y tế nhạy cảm",
  "consent.overview.law2023.title": "Luật Khám bệnh 2023 (Luật số 15/2023/QH15)",
  "consent.overview.law2023.desc": "AI đóng vai trò trợ lý thông tin y khoa, không thay thế bác sĩ. Mọi chỉ định can thiệp và đơn thuốc phải do nhân viên y tế trực tiếp chịu trách nhiệm.",
  "consent.overview.decree13.title": "Nghị định 13/2023/NĐ-CP (PDPD)",
  "consent.overview.decree13.desc": "Dữ liệu sức khỏe là dữ liệu cá nhân nhạy cảm, chỉ xử lý khi có đồng thuận theo từng mục đích riêng (granular consent). Bạn có quyền rút đồng thuận bất kỳ lúc nào.",
  "consent.overview.zeroCot.title": "Sổ cái Bất biến & Chuẩn Zero-CoT",
  "consent.overview.zeroCot.desc": "Mọi thay đổi đồng thuận được ghi vào sổ cái kiểm toán Zero-PII. Chuỗi suy luận AI (Chain-of-Thought) được tiêu hủy ngay sau xử lý, không lưu trữ vĩnh viễn.",
  ...
  "consent.purpose.medicalAiReasoning.description": "Hỗ trợ tra cứu tri thức y khoa, đối chiếu y văn Living Evidence và Dược thư quốc gia; không tự ý kê đơn hay chẩn đoán độc lập.",
  "consent.purpose.emergencyEscalation.label": "Luồng cấp cứu khẩn cấp",
  "consent.purpose.emergencyEscalation.description": "Tự động phát hiện dấu hiệu đe dọa tính mạng để kích hoạt cảnh báo gọi 115 và bỏ qua suy luận AI nhằm bảo đảm thời gian vàng cấp cứu.",
  "consent.purpose.prescriptionOcr.label": "Bóc tách đơn thuốc OCR",
  "consent.purpose.prescriptionOcr.description": "Sử dụng nhận diện thị giác máy tính bóc tách thông tin từ ảnh chụp đơn thuốc, nhãn thuốc vào Tủ thuốc để theo dõi an toàn.",
  "consent.purpose.scribeAmbient.label": "Ghi âm hội thoại Scribe",
  "consent.purpose.scribeAmbient.description": "Thu âm và nhận dạng giọng nói hội thoại khám bệnh trực tiếp để tạo bản tóm tắt lâm sàng SOAP có cấu trúc với sự đồng thuận của các bên.",
  "consent.purpose.familySharing.label": "Chia sẻ thành viên gia đình",
  "consent.purpose.familySharing.description": "Tạo liên kết xem chỉ đọc hoặc phân quyền theo dõi hồ sơ sức khỏe và lịch dùng thuốc cho người thân hoặc người chăm sóc.",
  "consent.purpose.researchDeidentification.label": "Khử định danh dữ liệu nghiên cứu",
  "consent.purpose.researchDeidentification.description": "Cho phép sử dụng dữ liệu lâm sàng đã khử định danh 100% (không chứa PII) để cải thiện chất lượng truy xuất và đối chiếu bằng chứng y khoa.",
  "consent.auditLog.title": "Nhật ký Kiểm toán Cấp & Thu hồi Đồng thuận",
  "consent.auditLog.subtitle": "Lưu vết bất biến mọi thay đổi trạng thái đồng thuận theo chuẩn Zero-PII",
  "consent.auditLog.empty": "Chưa có bản ghi thay đổi đồng thuận nào trong phiên này.",
  "consent.auditLog.actionGranted": "Đã cấp quyền",
  "consent.auditLog.actionRevoked": "Đã thu hồi",
  "consent.auditLog.zeroPiiBadge": "Nhật ký kiểm toán Zero-PII",
  ...
  "consent.detailSheet.lockedNotice": "Mục đích này là căn cứ pháp lý cốt lõi theo Luật Khám bệnh 2023 §15 và không thể hủy bỏ độc lập.",
  ...
  "dataRights.overview.subtitle": "Khung pháp lý bảo vệ quyền riêng tư và dữ liệu y tế cá nhân",
  "dataRights.overview.decree13.title": "Nghị định 13/2023/NĐ-CP (PDPD)",
  "dataRights.overview.decree13.desc": "Bạn có quyền được biết, đồng ý, truy cập, đính chính, xóa dữ liệu, hạn chế xử lý, cung cấp dữ liệu, phản đối và rút đồng thuận bất kỳ lúc nào.",
  "dataRights.overview.gdpr.title": "GDPR & Chuẩn Quốc Tế",
  "dataRights.overview.gdpr.desc": "Bảo đảm quyền chuyển đổi dữ liệu (portability - JSON máy đọc được), quyền được lãng quên (erasure) và minh bạch nhật ký kiểm toán bất biến.",
  "dataRights.overview.sensitiveHealth.title": "Bảo vệ Dữ liệu Y tế Nhạy cảm",
  "dataRights.overview.sensitiveHealth.desc": "Hồ sơ sức khỏe (PHR), toa thuốc, sinh hiệu và bệnh sử được bảo vệ trong ranh giới tạm thời không lưu CoT (Zero-CoT) và không dùng để huấn luyện AI công cộng.",
  ...
  "dataRights.action.auditLog.description": "Yêu cầu trích xuất toàn bộ nhật ký truy cập và lịch sử xử lý dữ liệu cá nhân theo tiêu chuẩn kiểm toán bảo mật bất biến.",
  ...
  "dataRights.destructive.description": "Yêu cầu xóa toàn bộ tài khoản và ẩn danh hóa dữ liệu y tế cá nhân khỏi hệ thống CLARA. Hành động này không thể hoàn tác sau khi xác nhận.",
  "dataRights.destructive.warningNote": "Lưu ý pháp lý: Theo Điều 9 & 16 Nghị định 13/2023/NĐ-CP và Luật Khám bệnh, chữa bệnh, một số bản ghi kiểm toán y khoa không định danh sẽ được lưu giữ theo quy định bắt buộc.",
  ...
  "auth.callback.description": "Đang hoàn tất quá trình xác thực và thiết lập phiên làm việc an toàn của bạn.",
  ...
  "research.workspace.evidence.internalSource": "Nguồn nội bộ hoặc tài liệu đính kèm.",
  "research.workspace.evidence.empty": "Chưa có nguồn bằng chứng cho câu trả lời này.",
  ...
  "research.workspace.timeline.waiting": "Máy chủ đang xử lý. Tiến trình sẽ hiện khi có sự kiện thực.",
  "research.workspace.timeline.empty": "Phiên này chưa có tiến trình do máy chủ cung cấp.",
  "research.workspace.timeline.mode.idle": "Đang chờ",
  "research.workspace.timeline.mode.flowEvents": "Sự kiện tiến trình trực tiếp",
  "research.workspace.timeline.mode.serverStages": "Tóm tắt các bước từ máy chủ",
  ...
  "research.workspace.timeline.payload.supportedClaims": "Luận điểm được hỗ trợ",
  ...
  "research.sourceHub.eyebrow": "Trung tâm Nguồn Nghiên cứu",
  ...
  "scribe.recordingData.error.delete": "Chưa thể xóa dữ liệu phiên âm. Vui lòng thử lại.",
  ...
  "errors.request_cancelled": "Yêu cầu đã bị hủy.",
  "errors.request_timeout": "Hệ thống phản hồi lâu hơn dự kiến. Vui lòng thử lại sau.",
  "errors.network_error": "Lỗi kết nối mạng. Vui lòng kiểm tra lại đường truyền.",
  ...
  "errors.not_found": "Không tìm thấy dữ liệu yêu cầu.",
  "errors.state_conflict": "Dữ liệu đã bị thay đổi hoặc có xung đột trạng thái.",
  "errors.validation_error": "Dữ liệu nhập vào chưa hợp lệ.",
  "errors.validation_failed": "Kiểm tra dữ liệu không thành công.",
  "errors.rate_limited": "Hệ thống đang nhận quá nhiều yêu cầu. Vui lòng thử lại sau ít phút.",
  "errors.server_error": "Hệ thống đang bận. Vui lòng thử lại sau.",
} as const;
...
const EN_MESSAGES: MessageCatalog = {
  ...
  "navigation.item.ask.subtitle": "Ask what concerns you; CLARA will guide the safest next step.",
  ...
  "navigation.item.health.subtitle": "Manage medical records, timeline, and confirmed medications.",
  "navigation.item.care.label": "Care",
  "navigation.item.care.desc": "Visits & care plan",
  "navigation.item.care.title": "Care Plan",
  "navigation.item.care.subtitle": "Prepare for visits and follow your care schedule.",
  "navigation.item.you.label": "You",
  "navigation.item.you.desc": "Account, sharing & privacy",
  "navigation.item.you.title": "Personal Account",
  "navigation.item.you.subtitle": "Manage profiles, family sharing, and privacy rights.",
  ...
  "navigation.item.dashboard.subtitle": "Quickly follow care and operational tasks for the day.",
  ...
  "navigation.item.research.subtitle": "In-depth analysis with sources, uncertainty, and a claim trail.",
  ...
  "navigation.item.evidence.subtitle": "Connect a question to your journey, sources, and what remains uncertain.",
  ...
  "navigation.item.selfmed.subtitle": "Manage current medicines and scan prescriptions from an image.",
  ...
  "navigation.item.careguard.subtitle": "Compare medicines, allergies, and symptoms to spot risks early.",
  ...
  "navigation.item.sourceHub.subtitle": "Synchronise and search medical sources for evidence analysis.",
  ...
  "navigation.item.council.subtitle": "Bring together multiple specialty perspectives for complex cases.",
  ...
  "navigation.item.scribe.subtitle": "Draft visit notes in a clear, consistent format.",
  "navigation.item.adminOverview.label": "System administration",
  "navigation.item.adminOverview.desc": "Coordinate configuration and operations",
  "navigation.item.adminOverview.title": "System administration",
  "navigation.item.adminOverview.subtitle": "Central coordination for configuration, response quality, and operations.",
  ...
  "navigation.item.adminKnowledgeSources.subtitle": "A central place for retrieval connectors, documents, and medical-source synchronisation.",
  ...
  "navigation.item.adminAnswerFlow.subtitle": "Coordinate analysis, verification, and the final response.",
  ...
  "navigation.item.adminObservability.subtitle": "Monitor system health, alerts, and runtime signals.",
  ...
  "navigation.item.adminModeration.subtitle": "Review and handle reports about community content.",
  ...
  "navigation.item.adminAnalytics.subtitle": "Usage trends, activity by area, conversion funnels, and retention.",
  "navigation.item.adminClinicalAnalytics.label": "Clinical analytics",
  "navigation.item.adminClinicalAnalytics.desc": "Verification, DDI, and latency",
  "navigation.item.adminClinicalAnalytics.title": "Clinical analytics",
  "navigation.item.adminClinicalAnalytics.subtitle": "FIDES verification decisions, medicine-interaction distribution, and latency by tier.",
  ...
  "guide.tasks.chat.detail": "Use this when you need a quick, readable answer with safety guidance.",
  ...
  "guide.tasks.chat.step3": "Read the safety guidance before acting on the answer.",
  "guide.tasks.chat.action": "Ask CLARA",
  "guide.tasks.thinking.title": "I want a more detailed answer",
  "guide.tasks.thinking.detail": "Use Thinking or Pro for longer analysis and broader sourcing.",
  "guide.tasks.thinking.step1": "Open the mode control beside the message box.",
  "guide.tasks.thinking.step2": "Choose Thinking for deeper analysis or Pro for a longer report.",
  "guide.tasks.thinking.step3": "Choose Full sources when you want CLARA to check a broader source set.",
  "guide.tasks.thinking.action": "Open Thinking mode",
  "guide.tasks.cabinet.title": "I want to save the medicines I take",
  "guide.tasks.cabinet.detail": "The medicine cabinet keeps your list ready for interaction checks.",
  ...
  "guide.tasks.cabinet.step3": "When at least two medicines are present, run an interaction check.",
  "guide.tasks.cabinet.action": "Open medicine cabinet",
  "guide.tasks.interactions.title": "I want to know whether two medicines interact",
  "guide.tasks.interactions.detail": "Use the interaction check before combining multiple medicines.",
  "guide.tasks.interactions.step1": "Make sure the cabinet contains at least two medicines.",
  "guide.tasks.interactions.step2": "Select Check medicine interactions.",
  "guide.tasks.interactions.step3": "Review each flagged pair and the What to do next section.",
  "guide.tasks.interactions.action": "Check interactions",
  "guide.tasks.council.title": "I am a clinician and need input on a complex case",
  "guide.tasks.council.detail": "Multi-specialty input can help when a case has several management paths or specialties.",
  "guide.tasks.council.step1": "Enter the clinical context clearly.",
  "guide.tasks.council.step2": "Add relevant test results or notes.",
  "guide.tasks.council.step3": "Use the result as supporting information, not as a replacement for clinical judgment.",
  "guide.tasks.council.action": "Open multi-specialty review",
  "guide.tasks.scribe.title": "I want to document a consultation",
  "guide.tasks.scribe.detail": "Consultation notes can be turned into a structured summary for review.",
  ...
  "guide.tasks.scribe.step3": "Do not include sensitive information without the appropriate consent.",
  ...
  "guide.labels.quick.meaning": "A shorter answer with less waiting, suitable for simple questions.",
  "guide.labels.thinking.term": "Thinking",
  "guide.labels.thinking.meaning": "Deeper analysis for questions that need an explanation.",
  "guide.labels.pro.term": "Pro",
  "guide.labels.pro.meaning": "A longer, more complete report for in-depth research.",
  "guide.labels.autoSources.term": "Automatic sources",
  "guide.labels.autoSources.meaning": "CLARA chooses an appropriate source scope to save time.",
  "guide.labels.fullSources.term": "Full sources",
  "guide.labels.fullSources.meaning": "CLARA checks a broader source set, which may take longer.",
  "phr.ocr.open": "Scan prescription (OCR)",
  "phr.ocr.title": "Review OCR results",
  "phr.ocr.intro": "Upload a prescription image or file. Nothing is saved until you confirm.",
  "phr.ocr.disclosure": "I agree to send this file for reviewable medication extraction. CLARA does not save medicines automatically from OCR.",
  "phr.ocr.consentNotice": "Appropriate medical consent is required before CLARA sends a file to the configured OCR service.",
  "phr.ocr.processingNotice": "CLARA does not persist the uploaded file; review every item before saving it to your record.",
  ...
  "phr.share.description": "Create read-only links to share your record. You can revoke them anytime.",
  ...
  "phr.shared.unavailable": "This shared link is invalid, expired, or has been revoked.",
  ...
  "phr.shared.observations": "Vital Signs & Measurements",
  "phr.shared.results": "Lab Results",
  "phr.shared.emergencyContact": "Emergency contact",
  "phr.shared.safety": "If there are danger signs or you need urgent help, contact the nearest medical facility.",
  ...
  "workspace.shared.unavailable": "This shared link is invalid, expired, or has been revoked.",
  ...
  "phr.export.description": "Download your record as a FHIR R4 bundle (application/fhir+json) to share with a clinic.",
  ...
  "phr.emergencyCard.description": "Choose which sections appear on your emergency card. The preview updates below.",
  ...
  "phr.reminders.description": "Set reminders for current medications with a frequency, track remaining supply, and nudge a caregiver.",
  "phr.reminders.medication": "Medication",
  "phr.reminders.chooseMed": "Choose medication",
  "phr.reminders.noEligible": "No current medication with a frequency yet. Add a frequency to a medication first.",
  ...
  "account.dataDelete.reviewDescription": "Read the consequences first. You can still return to My data without sending a request.",
  "account.dataDelete.confirmTitle": "Confirm your deletion request",
  "account.dataDelete.confirmDescription": "Only submit when you understand this request cannot be undone.",
  ...
  "account.dataDelete.consequence": "CLARA will process a request to delete or anonymize your personal data within the statutory window.",
  "account.dataDelete.retentionTitle": "Data retained",
  "account.dataDelete.retention": "Some audit or compliance records without identifying data may still be retained under legal obligations.",
  "account.dataDelete.confirmation": "I understand this request may delete or anonymize my personal data and cannot be undone.",
  ...
  "account.dataDelete.unknownReceipt": "This receipt could not be found. You can review your request history.",
  "account.dataDelete.unavailable": "Data-subject requests are not enabled for this environment yet.",
  ...
  "admin.dsar.description": "Monitor and resolve data-subject requests under Decree 13/2023/NĐ-CP, tracked against the statutory response window.",
  ...
  "navigation.item.consent.subtitle": "Give or withdraw consent for each personal-data processing purpose.",
  ...
  "navigation.item.dataRights.subtitle": "Exercise data-subject rights to export, correct, delete, restrict, or withdraw consent.",
  ...
  "navigation.item.dsar.subtitle": "Track and handle data-subject requests within the applicable legal deadline.",
  ...
  "navigation.item.community.subtitle": "Share experiences and support one another. This is not medical advice; content is moderated.",
  "navigation.page.researchRedirect.title": "Medical questions",
  "navigation.page.researchRedirect.subtitle": "The question-and-answer flow is now unified in CLARA Chat.",
  "navigation.page.controlTower.title": "Knowledge control",
  "navigation.page.controlTower.subtitle": "Configure data sources and response flows for the question-and-answer system.",
  "navigation.page.ecosystem.title": "Partner ecosystem",
  "navigation.page.ecosystem.subtitle": "Monitor connection status and trust in interoperable data.",
  "navigation.page.default.title": "Workspace",
  "navigation.page.default.subtitle": "A health-assistant platform that helps you work more clearly and quickly.",
  ...
  "familyCircle.relationships.description": "Only items you explicitly accepted supporting appear here.",
  ...
  "today.completedDescription": "Completed tasks have been recorded. You can rest or add an update if something changes.",
  ...
  "today.caughtUpDescription": "Your journey is still being tracked. Open LifeMap to review or adjust the next step.",
  ...
  "today.emergencyCardDesc": "Critical blood type, allergy & emergency contact details when urgent support is needed.",
  "today.emergencyCardAction": "View Medical ID",
  "today.whatsNew": "What’s new?",
  "today.whatsNewDesc": "Lab results and prescriptions securely updated from your health records.",
  ...
  "today.askPlaceholder": "Ask about medicines, symptoms or care plans…",
  ...
  "today.taskDetail.pageDescription": "Review one task, understand when it is due, then confirm it is done.",
  "today.taskDetail.completedPageTitle": "Completed",
  "today.taskDetail.completedPageDescription": "This task was recorded. You can return to see your next priority.",
  "today.taskDetail.completedTitle": "Completion recorded",
  "today.taskDetail.completedDescription": "CLARA does not infer any further care action from this task.",
  ...
  "today.taskDetail.completeGuidance": "Confirm only after you have done this task. If the plan no longer fits, return to LifeMap to review and adjust the context.",
  ...
  "today.taskDetail.notFoundDescription": "It may already be completed, adjusted, or opened from an older link.",
  "today.taskDetail.activityTitle": "Activity History & Provenance",
  "chatShares.title": "Manage shared links",
  "chatShares.description": "Manage public conversation links. You can revoke access at any time.",
  ...
  "lifemap.wizard.step.condition": "2. Condition & Meds",
  "lifemap.wizard.step.milestones": "3. Milestones & Metrics",
  "lifemap.wizard.step.companions": "4. Companions & Reminders",
  "lifemap.wizard.step.commitment": "5. Preview & Commitment",
  "lifemap.wizard.goal.title": "What is your health goal?",
  "lifemap.wizard.goal.description": "Choose a popular goal template below or enter a custom name for your health journey.",
  ...
  "lifemap.wizard.goal.template1Desc": "Track daily blood pressure readings and maintain a low-sodium diet.",
  "lifemap.wizard.goal.template2": "Blood sugar & nutrition management",
  "lifemap.wizard.goal.template2Desc": "Monitor fasting and post-prandial blood glucose, and log meals.",
  "lifemap.wizard.goal.template3": "Sleep improvement & stress reduction",
  "lifemap.wizard.goal.template3Desc": "Track hours of sleep, sleep quality, and wake-up times.",
  "lifemap.wizard.goal.template4": "Knee joint physical rehabilitation",
  "lifemap.wizard.goal.template4Desc": "Perform daily physical therapy exercises and log movement pain scores.",
  "lifemap.wizard.goal.template5": "Dyslipidemia monitoring",
  "lifemap.wizard.goal.template5Desc": "Track LDL-C, maintain healthy nutrition and schedule lipid profile checks.",
  "lifemap.wizard.goal.template6": "Personal custom",
  "lifemap.wizard.goal.template6Desc": "Set up custom longitudinal tracking and personalized health targets.",
  ...
  "lifemap.wizard.goal.customGoalPlaceholder": "e.g. Maintain blood pressure below 130/80 mmHg and take medication on time every morning.",
  "lifemap.wizard.condition.title": "Clinical Condition & Symptoms Intake",
  "lifemap.wizard.condition.description": "Record related diagnoses and initial symptoms to personalize your health tracking plan.",
  "lifemap.wizard.condition.cabinetTitle": "Personal Medicine Cabinet (Auto-detected)",
  "lifemap.wizard.condition.cabinetEmpty": "No medicines found in personal cabinet.",
  "lifemap.wizard.condition.addMedication": "Add medication",
  "lifemap.wizard.condition.addMedicationPlaceholder": "Enter drug name & dosage (e.g. Amlodipine 5mg)...",
  "lifemap.wizard.condition.trackedMedsLabel": "Prescription medicines tracked in this journey:",
  "lifemap.wizard.condition.optDyslipidemia": "Dyslipidemia / High Cholesterol",
  "lifemap.wizard.condition.optPregnancy": "Pregnancy & Antenatal Care",
  "lifemap.wizard.condition.optPostop": "Post-operative Rehabilitation",
  ...
  "lifemap.wizard.condition.symptomsPlaceholder": "e.g. Occasional morning neck stiffness, mild palpitations when climbing stairs...",
  ...
  "lifemap.wizard.condition.priorityHint": "Priority helps order tasks and reminders on your dashboard; not a medical triage score.",
  "lifemap.wizard.milestones.title": "Target Milestone Planning",
  "lifemap.wizard.milestones.description": "Define measurement targets and follow-up schedules to evaluate health progress.",
  "lifemap.wizard.milestones.targetBpLabel": "Target Blood Pressure (mmHg)",
  "lifemap.wizard.milestones.targetBpPlaceholder": "< 130/80 mmHg",
  "lifemap.wizard.milestones.targetGlucoseLabel": "Target Fasting Glucose (mmol/L)",
  "lifemap.wizard.milestones.targetGlucosePlaceholder": "< 7.0 mmol/L",
  "lifemap.wizard.milestones.m1Label": "First Target Milestone (Milestone 1)",
  "lifemap.wizard.milestones.m1Placeholder": "e.g. Complete 7 consecutive days of morning & evening BP logging",
  "lifemap.wizard.milestones.cadenceLabel": "Tracking Cadence",
  "lifemap.wizard.milestones.cadenceDaily": "Daily",
  "lifemap.wizard.milestones.cadenceTwiceWeekly": "Twice weekly (2 times/week)",
  ...
  "lifemap.wizard.companions.title": "Care Companions & Smart Reminders",
  "lifemap.wizard.companions.description": "Configure medication reminder schedules and share tracking with family or care physician.",
  "lifemap.wizard.companions.reminderTitle": "Smart Medication Reminder Schedules",
  "lifemap.wizard.companions.slotMorning": "Morning (08:00)",
  "lifemap.wizard.companions.slotNoon": "Noon (12:00)",
  "lifemap.wizard.companions.slotEvening": "Evening (18:00)",
  "lifemap.wizard.companions.slotNight": "Night (20:00)",
  "lifemap.wizard.companions.addReminder": "Add reminder slot",
  "lifemap.wizard.companions.shareTitle": "Care Companion & Attending Physician",
  "lifemap.wizard.companions.nameLabel": "Companion or Physician Name",
  "lifemap.wizard.companions.namePlaceholder": "e.g. Dr. Nguyen Van A or Daughter (Lan)",
  "lifemap.wizard.companions.roleLabel": "Companion Role",
  "lifemap.wizard.companions.roleFamily": "Family Member",
  "lifemap.wizard.companions.roleDoctor": "Attending Physician",
  "lifemap.wizard.companions.roleCaregiver": "Caregiver",
  "lifemap.wizard.companions.contactLabel": "Phone Number or Email",
  "lifemap.wizard.companions.contactPlaceholder": "e.g. 0912345678 or doctor@clara.care",
  "lifemap.wizard.companions.notifyAlerts": "Receive alerts when vitals exceed safe thresholds",
  "lifemap.wizard.companions.notifySummary": "Send weekly progress summary report",
  "lifemap.wizard.preview.title": "Journey Preview & GLHS Commitment",
  "lifemap.wizard.preview.description": "Visual journey summary before official activation into the GLHS health ledger.",
  "lifemap.wizard.preview.cardTitle": "LifeMap Journey Summary Card",
  "lifemap.wizard.preview.glhsBadge": "GLHS v2 Ledger • 6-Phase OCC Kernel",
  "lifemap.wizard.preview.glhsSecurityNote": "This journey is encrypted and immutably protected under the Governed Longitudinal Health State standard.",
  "lifemap.wizard.commitment.title": "Commitment & Start Journey",
  "lifemap.wizard.commitment.description": "Review your journey plan and confirm your commitment to self-care.",
  ...
  "lifemap.wizard.commitment.statement": "I commit to following this health tracking plan and proactively consulting my physician when needed.",
  "lifemap.wizard.commitment.disclaimer": "Safety notice: LifeMap is a personal health tracking tool and does not replace professional medical diagnosis or treatment.",
  "lifemap.wizard.commitment.submit": "Commit & Start Journey",
  "lifemap.wizard.commitment.activateAction": "Activate Journey & Commit to GLHS",
  ...
  "lifemap.wizard.error.commitmentRequired": "Please check the commitment acknowledgment box before starting.",
  "lifemap.wizard.error.saveFailed": "Could not create journey due to a network issue. Your draft remains safe.",
  "lifemap.timeline.eyebrow": "LifeMap",
  "lifemap.timeline.title": "Expanded Journey Timeline",
  "lifemap.timeline.description": "Chronological and bitemporal stream of journey milestones, journal entries, and clinical encounters.",
  ...
  "lifemap.timeline.actions.viewTimeline": "View Timeline",
  "lifemap.timeline.actions.exportHistory": "Export History",
  "lifemap.timeline.actions.addNote": "Add Corrective Note",
  ...
  "lifemap.timeline.perspective.validDesc": "Ordered by the actual time symptoms occurred or medications were taken.",
  "lifemap.timeline.perspective.transactionDesc": "Ordered by the time data was entered by clinicians or synced into the system.",
  ...
  "lifemap.timeline.filter.type.medications": "Medications",
  "lifemap.timeline.filter.type.labs": "Labs & Diagnostics",
  "lifemap.timeline.filter.type.symptoms": "Symptoms",
  "lifemap.timeline.filter.type.reports": "Reports & Documents",
  ...
  "lifemap.timeline.empty.description": "No events match your current filter. Try selecting a different timeline perspective or search term.",
  ...
  "lifemap.timeline.item.medication": "Medication",
  "lifemap.timeline.item.lab": "Lab Result",
  "lifemap.timeline.item.symptom": "Clinical Symptom",
  "lifemap.timeline.item.report": "Medical Report",
  ...
  "lifemap.timeline.item.disputedNotice": "This event is currently disputed and awaiting clinician verification.",
  "lifemap.timeline.inspector.validTime": "Valid Time (Occurrence)",
  "lifemap.timeline.inspector.transactionTime": "Transaction Time (Recorded)",
  "lifemap.timeline.inspector.revision": "Event Revision",
  "lifemap.timeline.inspector.truthState": "Truth State",
  "lifemap.timeline.inspector.attribution": "Attribution Source",
  "lifemap.timeline.inspector.sourceKind": "Source Kind",
  "lifemap.timeline.inspector.policyVersion": "Policy Version",
  "lifemap.timeline.inspector.integrity": "Integrity & Audit",
  "lifemap.timeline.inspector.revisionsTitle": "Revision History",
  "lifemap.timeline.inspector.provenanceTitle": "Provenance & Data Integrity",
  "lifemap.timeline.inspector.truthStateDesc": "State reflects clinical verification level and data truth authority.",
  "lifemap.timeline.dispute.placeholder": "Enter dispute reason or corrected details...",
  "lifemap.timeline.dispute.submitting": "Submitting dispute...",
  "lifemap.timeline.correctiveModal.title": "Add Corrective / Supplementary Note",
  "lifemap.timeline.correctiveModal.desc": "This note will be immutably recorded into the event audit history and increment its revision.",
  "lifemap.timeline.correctiveModal.noteLabel": "Correction Details",
  "lifemap.timeline.correctiveModal.placeholder": "e.g., Note on taking medication after meal, or minor side effect observed...",
  "lifemap.timeline.correctiveModal.authorLabel": "Correction Author",
  "lifemap.timeline.correctiveModal.save": "Save Correction",
  "lifemap.timeline.export.success": "Timeline history exported successfully ({count} events)",
  "lifemap.timeline.journalModal.title": "Record New Health Journal",
  "lifemap.timeline.journalModal.desc": "Record symptoms, measurement vitals, or your general health observations today.",
  ...
  "lifemap.timeline.journalModal.contentPlaceholder": "Add notes on measured blood pressure, food intake, taken medications...",
  ...
  "lifemap.timeline.journalModal.typeMedication": "Medication Intake",
  "lifemap.timeline.journalModal.typeReport": "Medical Report / Document",
  ...
  "chat.welcome.promise": "Sourced when available · Stated limits · Contextual safety signals",
  ...
  "chat.answerRenderer.releaseBoundary.title": "There is not enough evidence for a confident answer",
  "chat.answerRenderer.releaseBoundary.description": "CLARA withheld the conclusion because the evidence did not pass the required checks. Narrow the question, inspect the sources, or prepare information to discuss with a clinician.",
  ...
  "medicines.description": "Manage confirmed medication, your personal medicine cabinet and safe interaction checks in one place.",
  ...
  "medicines.workspace.activeTaking.desc": "Medications currently in active treatment regimen, reconciled with canonical sources.",
  "medicines.workspace.activeTaking.empty": "No active medications in your current regimen.",
  "medicines.workspace.unresolved.title": "Needs Confirmation & Unverified Proposals",
  "medicines.workspace.unresolved.desc": "Medications not yet matched to canonical catalog or requiring dose verification before clinical trust.",
  "medicines.workspace.unresolved.allReconciled": "All active medications are verified and reconciled.",
  "medicines.workspace.unresolved.pendingCount": "{count} medications require identity or dose review",
  "medicines.workspace.ddi.title": "Drug Interaction Safety Guard",
  "medicines.workspace.ddi.desc": "Automated pharmacologic cross-check across active regimens and cabinet inventory to detect adverse interactions and contraindications.",
  "medicines.workspace.ddi.badge": "DrugBank v5.1 & Safety Verification",
  "medicines.workspace.ddi.highlight1": "Two-medicine guard: Requires at least 2 distinct drugs",
  "medicines.workspace.ddi.highlight2": "Verified against DrugBank v5.1 with multi-stage cross-checking",
  "medicines.workspace.ddi.highlight3": "Fail-closed invariant: Never fabricates false all-clear",
  "medicines.workspace.ddi.action": "Open Interaction Checker",
  "medicines.workspace.ddi.ready": "Ready with {count} distinct active medications.",
  "medicines.workspace.ddi.needsTwo": "Requires at least 2 distinct medications to check interactions.",
  "medicines.workspace.cabinet.title": "Home Medicine Cabinet (Secondary Inventory)",
  "medicines.workspace.cabinet.desc": "Medication inventory stored at home. This is secondary inventory and is NEVER merged with active treatment.",
  "medicines.workspace.cabinet.disclaimer": "Cabinet items are home possession inventory only, not active treatment courses.",
  ...
  "medicines.cabinet.wizard.safetyNote": "Safety invariant: Medicines added to home cabinet represent possession/backup inventory only and are NOT automatically converted to active treatment. Always perform an interaction check before combined usage.",
  "medicines.cabinet.wizard.aside": "Home cabinet stores backup possession inventory, kept strictly separate from active medication regimens.",
  ...
  "medicines.cabinet.verifiedDescription": "CLARA does not guess warnings from medicines in your cabinet. Open interaction check to verify against trusted pharmacopoeia sources; if verification is unavailable, results pause safely.",
  ...
  "flow.fixBeforeContinue": "A few items need to be corrected before you continue.",
  ...
  "visits.howPrepWorksDesc": "CLARA helps you summarize symptoms, current medications, questions for your doctor, and securely organize post-visit records with full privacy control.",
  ...
  "visitWizard.desc.reason": "Identify your primary goal, specialty, and clinician for this visit.",
  ...
  "visitWizard.desc.symptoms": "Record abnormal symptoms, onset timeline, and how they affect your daily activities.",
  ...
  "visitWizard.desc.medications": "Reconcile active medications, dosage adherence, and known allergic reactions.",
  "visitWizard.field.medicationsList": "Active medications list",
  "visitWizard.field.allergiesList": "Known allergies (drugs, food, environmental)",
  ...
  "visitWizard.desc.summary": "CLARA synthesized your information into a clinical handoff pack and suggested high-yield doctor questions.",
  ...
  "visitDetail.soap.subjective": "S · Subjective (Chief complaint & History)",
  ...
  "visitDetail.rx.safetyCheck": "DrugBank Safety Check: No high-risk adverse interactions detected.",
  ...
  "visitDetail.questions.title": "Discussed Questions & Clinician Answers",
  ...
  "consent.ledgerSubtitle": "Granular consent grant and revocation per specific clinical purpose",
  "consent.overview.title": "Statutory Consent Overview: Medical Law 2023 & Decree 13",
  "consent.overview.subtitle": "Clinical boundaries & sensitive health data governance",
  "consent.overview.law2023.title": "Vietnamese Medical Law 2023 (Law 15/2023/QH15)",
  "consent.overview.law2023.desc": "AI acts as an informational clinical assistant, never replacing licensed physicians. All prescriptions and interventions require licensed clinician verification.",
  "consent.overview.decree13.title": "Decree 13/2023/NĐ-CP (PDPD)",
  "consent.overview.decree13.desc": "Health data is classified as sensitive personal data, processed solely under granular, purpose-specific consent. Withdrawal is as easy as granting at any time.",
  "consent.overview.zeroCot.title": "Immutable Ledger & Zero-CoT Standard",
  "consent.overview.zeroCot.desc": "All consent transactions are recorded in an append-only, zero-PII audit ledger. AI clinical reasoning chains (Chain-of-Thought) are purged immediately after execution.",
  ...
  "consent.purpose.medicalAiReasoning.label": "Medical AI Assistant reasoning",
  "consent.purpose.medicalAiReasoning.description": "Assists clinical literature retrieval, Living Evidence referencing, and Vietnamese Pharmacopeia checks; does not prescribe or diagnose independently.",
  "consent.purpose.emergencyEscalation.label": "Emergency escalation fast-path",
  "consent.purpose.emergencyEscalation.description": "Automatically detects life-threatening emergency symptoms to escalate 115 emergency calling and skip AI reasoning to protect the golden hour.",
  "consent.purpose.prescriptionOcr.label": "Prescription OCR scanning",
  "consent.purpose.prescriptionOcr.description": "Uses computer vision OCR to extract medication names, dosage, and schedules from prescription photos into the personal medicine cabinet.",
  "consent.purpose.scribeAmbient.label": "Scribe ambient transcription",
  "consent.purpose.scribeAmbient.description": "Captures ambient clinical dialogue audio to generate structured draft SOAP notes with explicit participant consent.",
  "consent.purpose.familySharing.label": "Family member sharing",
  "consent.purpose.familySharing.description": "Generates read-only sharing links or permission-gated access for health records and medication schedules to caregivers or family members.",
  "consent.purpose.researchDeidentification.label": "Research data de-identification",
  "consent.purpose.researchDeidentification.description": "Allows fully de-identified clinical data (zero PII) to be utilized for retrieval benchmark improvements and evidence verification.",
  "consent.auditLog.title": "Consent Revocation & Grant Audit Log",
  "consent.auditLog.subtitle": "Append-only immutable record of all consent state transitions under Zero-PII standards",
  "consent.auditLog.empty": "No consent transition events recorded yet in this session.",
  ...
  "consent.detailSheet.lockedNotice": "This is the core statutory lawful basis under Medical Law 2023 §15 and cannot be revoked individually.",
  ...
  "dataRights.overview.title": "Data Rights Overview Under Decree 13 & GDPR",
  "dataRights.overview.subtitle": "Statutory privacy framework protecting your personal and medical records",
  "dataRights.overview.decree13.title": "Decree 13/2023/NĐ-CP (PDPD)",
  "dataRights.overview.decree13.desc": "You hold full rights to be informed, consent, access, correct, erase, restrict processing, obtain personal data, object, and withdraw consent at any time.",
  "dataRights.overview.gdpr.title": "GDPR & Global Standards",
  "dataRights.overview.gdpr.desc": "Guarantees data portability in machine-readable JSON format, the right to erasure (be forgotten), and immutable audit log transparency.",
  "dataRights.overview.sensitiveHealth.title": "Sensitive Health Data Safeguards",
  "dataRights.overview.sensitiveHealth.desc": "Personal health records (PHR), prescriptions, vitals, and conditions are protected within ephemeral boundaries with Zero-CoT retention and zero public model training.",
  ...
  "dataRights.action.auditLog.description": "Request an immutable audit log extract detailing all access, modification, and processing events on your personal data.",
  ...
  "dataRights.destructive.description": "Request permanent deletion and irreversible anonymization of your account and personal health data from CLARA. This action cannot be reversed.",
  "dataRights.destructive.warningNote": "Legal notice: Under Decree 13/2023/NĐ-CP and the Law on Medical Examination and Treatment, non-identifying medical audit records are retained under statutory compliance obligations.",
  ...
  "auth.callback.description": "Completing authentication and setting up your secure session.",
  ...
  "research.workspace.evidence.internalSource": "Internal source or attached document.",
  "research.workspace.evidence.empty": "There are no evidence sources for this answer yet.",
  ...
  "research.workspace.timeline.waiting": "The server is processing. Progress appears when real events are available.",
  "research.workspace.timeline.empty": "There is no server-provided progress for this session yet.",
  ...
  "research.workspace.timeline.mode.serverAwait": "Server reasoning in progress",
  ...
  "scribe.recordingData.error.delete": "We could not delete the transcription data. Please try again.",
  ...
  "errors.network_error": "Network connection error. Please check your connection.",
  ...
  "errors.state_conflict": "State conflict or resource was modified.",
  "errors.validation_error": "Invalid input data.",
  "errors.validation_failed": "Validation check failed.",
  "errors.rate_limited": "Rate limit exceeded. Please try again shortly.",
  "errors.server_error": "Internal server error. Please try again.",
};
...
export function t(
  ...
  const catalog = UI_MESSAGES[locale] ?? UI_MESSAGES.vi;
  const template = catalog[key] ?? UI_MESSAGES.vi?.[key] ?? UI_MESSAGES.en?.[key] ?? (key as string);
