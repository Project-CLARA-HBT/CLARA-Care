...
export function LandingNav() {
  ...
  const navLinks = [
    ...
    { href: "#chat", label: copy.nav.features },
    { href: "#safety", label: copy.nav.safety },
    { href: "#clinical-transition", label: copy.nav.clinical },
  ];
            ...
            <div className="flex items-center justify-between pb-3 border-b border-[#E3E8EF]">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#6D7A8E]">{copy.nav.brandTag}</p>
                </div>
              </div>
