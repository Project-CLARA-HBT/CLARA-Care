...
export const V7_DEMO_SOURCES: V7DemoSource[] = [
  {
    id: "dav-national",
...
export const V7_DEMO_MEDICINES: V7DemoMedicine[] = [
  {
    id: "med-1",
    name: "Metformin HCl",
    dosage: "500 mg",
...
export const V7_DEMO_PHR_FIELDS: V7DemoPhrField[] = [
  {
    id: "phr-allergies",
