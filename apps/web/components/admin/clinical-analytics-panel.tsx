...
/**
 * Clinical_Analytics dashboard panel (Requirements 8.3, 8.5).
 *
...
export default function ClinicalAnalyticsPanel() {
  ...
  return (
    <div className="space-y-5">
      ...
      >
        {(analytics) => <ClinicalAnalyticsContent analytics={analytics} />}
      </AsyncSection>
    </div>
  );
}

function ClinicalAnalyticsContent({ analytics }: { analytics: ClinicalAnalytics }) {
