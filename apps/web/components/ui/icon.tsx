...
const LEGACY_ICON_NAMES: Record<string, IconName> = {
  ...
  labs: "scan",
  left_panel_close: "arrow-left",
  left_panel_open: "arrow-right",
  lock: "warning",
  medication: "medication",
  monitoring: "progress",
  more_horiz: "more",
  prompt_suggestion: "clinical-notes",
  right_panel_close: "arrow-right",
  schedule: "progress",
  science: "scan",
  share: "share",
  spa: "body",
...
const ICON_PATHS: Record<IconName, string> = {
  ...
  help: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-2.1-11a2.2 2.2 0 1 1 3.9 1.4c-.8.8-1.8 1.1-1.8 2.6m0 3h.01",
  ...
  settings: "M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm0-12v2m0 13v2m8.5-8.5h-2m-13 0h-2m14.5-6.5-1.4 1.4m-9.2 9.2-1.4 1.4m0-12 1.4 1.4m9.2 9.2 1.4 1.4",
