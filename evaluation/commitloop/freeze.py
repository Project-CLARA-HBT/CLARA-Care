...
FREEZE_INPUTS = (
    ...
    "evaluation/comparator_studies/temporal_bm25/METHOD_CARD.md",
    "evaluation/comparator_studies/temporal_bm25/DEVIATIONS.md",
    "evaluation/comparator_studies/official_graphrag/contract.py",
    "evaluation/comparator_studies/official_graphrag/METHOD_CARD.md",
...
def _validate_local_evidence(evidence: dict[str, Any], *, expected_git_sha: str) -> None:
    ...
    if missing_gates:
        raise FreezeError("local_validation_gates_missing:" + ",".join(sorted(missing_gates)))
...
def create_implementation_freeze(
    *, run_dir: Path, repository_root: Path, validation_evidence: dict[str, Any]
    ...
    replacement_calls = validation_evidence.get("phase_b_calls_before_replacement_freeze", 0)
    ...
    serialized_evidence = json.dumps(validation_evidence, sort_keys=True).encode("utf-8")
    ...
    payload = {
        ...
        "artifact_inventory_before_freeze_sha256": _sha256(run_dir / "checksums.sha256"),
