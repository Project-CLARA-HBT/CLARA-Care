...
def _manifest(root: Path, catalog: Path, statistics: Path) -> dict[str, object]:
    ...
    return {
        ...
        "non_equivalence_review": {"status": "dual_model_reviewed", "model_ids": ["gemini-3.6-flash-high", "claude-sonnet-4-6"], "results_sha256": "b" * 64, "included_mutant_ids": ["M01-A", "M02-A"], "unresolved_mutant_ids": []},
    }
...
def test_final_freeze_rejects_unreviewed_or_changed_inputs(
    ...
    value["non_equivalence_review"]["results_sha256"] = "not-a-hash"
